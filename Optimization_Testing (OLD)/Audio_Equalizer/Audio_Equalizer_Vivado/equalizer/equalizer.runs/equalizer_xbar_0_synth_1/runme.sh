...
HD_PWD='C:/EECE4632FinalProject/Audio_Equalizer/Audio_Equalizer_Vivado/equalizer/equalizer.runs/equalizer_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log equalizer_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source equalizer_xbar_0.tcl
