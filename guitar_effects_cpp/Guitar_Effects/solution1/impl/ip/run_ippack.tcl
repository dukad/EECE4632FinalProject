...
set Interfaces {
    s_axi_control_r {
        ...
        registers {{0x10 control W 0x0 "Data signal of control" {{0 8 control W 0 "Bit 7 to 0 of control"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 distortion_threshold W 0x0 "Data signal of distortion_threshold" {{0 16 distortion_threshold W 0 "Bit 15 to 0 of distortion_threshold"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 distortion_clip_factor W 0x0 "Data signal of distortion_clip_factor" {{0 32 distortion_clip_factor W 0 "Bit 31 to 0 of distortion_clip_factor"}}} {0x28 compression_min_threshold W 0x0 "Data signal of compression_min_threshold" {{0 16 compression_min_threshold W 0 "Bit 15 to 0 of compression_min_threshold"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 compression_max_threshold W 0x0 "Data signal of compression_max_threshold" {{0 16 compression_max_threshold W 0 "Bit 15 to 0 of compression_max_threshold"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 compression_zero_threshold W 0x0 "Data signal of compression_zero_threshold" {{0 16 compression_zero_threshold W 0 "Bit 15 to 0 of compression_zero_threshold"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 delay_mult W 0x0 "Data signal of delay_mult" {{0 32 delay_mult W 0 "Bit 31 to 0 of delay_mult"}}} {0x48 delay_samples W 0x0 "Data signal of delay_samples" {{0 32 delay_samples W 0 "Bit 31 to 0 of delay_samples"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
