...
set Library     "hls"
set IPName      "guitar_effects"
set Version     "1.0"
set DisplayName "Guitar_effects"
set Revision    "2113525836"
...
set xo_kernel_name "guitar_effects"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/EECE4632FinalProject/guitar_effects_cpp/Guitar_Effects/solution1"
set debug_dir "C:/EECE4632FinalProject/guitar_effects_cpp/Guitar_Effects/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {guitar_effects_fadd_32ns_32ns_32_5_full_dsp_1
guitar_effects_srem_11ns_10ns_9_15_1
guitar_effects_guitar_effects_Pipeline_LPF_Loop_lpf_coefficients_ROM_AUTO_1R
guitar_effects_flow_control_loop_pipe_sequential_init
...
## Variables
set Top "guitar_effects"
set TopNoPrefix "guitar_effects"
...
set Interfaces {
    s_axi_control_r {
        ...
        registers {{0x10 axilite_out R 0x0 "Data signal of axilite_out" {{0 32 axilite_out R 0 "Bit 31 to 0 of axilite_out"}}} {0x14 axilite_out_ctrl R 0x0 "Control signal of axilite_out" {{0 1 axilite_out_ap_vld R 0 "Control signal axilite_out_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 control W 0x0 "Data signal of control" {{0 8 control W 0 "Bit 7 to 0 of control"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 distortion_threshold W 0x0 "Data signal of distortion_threshold" {{0 32 distortion_threshold W 0 "Bit 31 to 0 of distortion_threshold"}}} {0x30 distortion_clip_factor W 0x0 "Data signal of distortion_clip_factor" {{0 8 distortion_clip_factor W 0 "Bit 7 to 0 of distortion_clip_factor"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 compression_min_threshold W 0x0 "Data signal of compression_min_threshold" {{0 32 compression_min_threshold W 0 "Bit 31 to 0 of compression_min_threshold"}}} {0x40 compression_max_threshold W 0x0 "Data signal of compression_max_threshold" {{0 32 compression_max_threshold W 0 "Bit 31 to 0 of compression_max_threshold"}}} {0x48 compression_zero_threshold W 0x0 "Data signal of compression_zero_threshold" {{0 32 compression_zero_threshold W 0 "Bit 31 to 0 of compression_zero_threshold"}}} {0x50 delay_mult W 0x0 "Data signal of delay_mult" {{0 32 delay_mult W 0 "Bit 31 to 0 of delay_mult"}}} {0x58 delay_samples W 0x0 "Data signal of delay_samples" {{0 32 delay_samples W 0 "Bit 31 to 0 of delay_samples"}}} {0x60 tempo W 0x0 "Data signal of tempo" {{0 32 tempo W 0 "Bit 31 to 0 of tempo"}}} {0x68 wah_coeffs_1 W 0x0 "Data signal of wah_coeffs" {{0 32 wah_coeffs W 0 "Bit 31 to 0 of wah_coeffs"}}} {0x6c wah_coeffs_2 W 0x0 "Data signal of wah_coeffs" {{0 32 wah_coeffs W 0 "Bit 63 to 32 of wah_coeffs"}}} {0x74 debug_output R 0x0 "Data signal of debug_output" {{0 32 debug_output R 0 "Bit 31 to 0 of debug_output"}}} {0x78 debug_output_ctrl R 0x0 "Control signal of debug_output" {{0 1 debug_output_ap_vld R 0 "Control signal debug_output_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control_r m_axi_gmem INPUT_r OUTPUT_r"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
