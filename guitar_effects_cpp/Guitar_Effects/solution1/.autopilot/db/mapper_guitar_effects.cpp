...
extern "C" void guitar_effects(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
...
auto* sINPUT_V_data_V = bcsim::createStream((hls::stream<short>*)__xlx_apatb_param_INPUT_V_data_V);
...
auto* sINPUT_V_dest_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_INPUT_V_dest_V);
  ...
  short* __xlx_OUTPUT_V_data_V_input_buffer= new short[ap_apatb_OUTPUT_V_data_V_cap_bc];
auto* sOUTPUT_V_data_V = bcsim::createStream((hls::stream<short>*)__xlx_apatb_param_OUTPUT_V_data_V);
...
auto* sOUTPUT_V_dest_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_OUTPUT_V_dest_V);
  // DUT call
  guitar_effects(sINPUT_V_data_V->data<short>(), sINPUT_V_keep_V->data<char>(), sINPUT_V_strb_V->data<char>(), sINPUT_V_user_V->data<char>(), sINPUT_V_last_V->data<char>(), sINPUT_V_id_V->data<char>(), sINPUT_V_dest_V->data<char>(), sOUTPUT_V_data_V->data<short>(), sOUTPUT_V_keep_V->data<char>(), sOUTPUT_V_strb_V->data<char>(), sOUTPUT_V_user_V->data<char>(), sOUTPUT_V_last_V->data<char>(), sOUTPUT_V_id_V->data<char>(), sOUTPUT_V_dest_V->data<char>(), __xlx_apatb_param_control, __xlx_apatb_param_distortion_threshold, __xlx_apatb_param_distortion_clip_factor, __xlx_apatb_param_compression_min_threshold, __xlx_apatb_param_compression_max_threshold, __xlx_apatb_param_compression_zero_threshold, __xlx_apatb_param_delay_mult, __xlx_apatb_param_delay_samples);
sINPUT_V_data_V->transfer((hls::stream<short>*)__xlx_apatb_param_INPUT_V_data_V);
...
sOUTPUT_V_data_V->transfer((hls::stream<short>*)__xlx_apatb_param_OUTPUT_V_data_V);
