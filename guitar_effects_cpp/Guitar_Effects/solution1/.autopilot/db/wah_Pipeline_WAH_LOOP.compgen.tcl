...
set name guitar_effects_srem_9ns_8ns_7_13_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { wah_values_buffer_address0 { O 7 vector } wah_values_buffer_ce0 { O 1 bit } wah_values_buffer_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { control_signal_buffer_address0 { O 7 vector } control_signal_buffer_ce0 { O 1 bit } control_signal_buffer_q0 { I 5 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    id 22 \
    name temp_result_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_temp_result_out \
    op interface \
    ports { temp_result_out { O 32 vector } temp_result_out_ap_vld { O 1 bit } } \
} "
}
