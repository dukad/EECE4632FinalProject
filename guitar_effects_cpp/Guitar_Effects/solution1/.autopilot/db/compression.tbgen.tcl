...
set C_modelArgList {
	...
	{ min_threshold int 16 regular  }
	{ max_threshold int 16 regular  }
	{ zero_threshold int 16 regular  }
	{ current_level_read int 16 regular  }
	{ values_buffer int 16 regular {array 441 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_r", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "min_threshold", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "max_threshold", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "zero_threshold", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "current_level_read", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "values_buffer", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ min_threshold sc_in sc_lv 16 signal 1 } 
	{ max_threshold sc_in sc_lv 16 signal 2 } 
	{ zero_threshold sc_in sc_lv 16 signal 3 } 
	{ current_level_read sc_in sc_lv 16 signal 4 } 
	...
	{ values_buffer_d0 sc_out sc_lv 16 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "min_threshold", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "min_threshold", "role": "default" }} , 
 	{ "name": "max_threshold", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "max_threshold", "role": "default" }} , 
 	{ "name": "zero_threshold", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "zero_threshold", "role": "default" }} , 
 	{ "name": "current_level_read", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "current_level_read", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fdiv_32ns_32ns_32_16_no_dsp_1_U3", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sitofp_32s_32_6_no_dsp_1_U4", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sitofp_32s_32_6_no_dsp_1_U5", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sdiv_16ns_16s_16_20_seq_1_U6", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	min_threshold { ap_none {  { min_threshold in_data 0 16 } } }
	max_threshold { ap_none {  { max_threshold in_data 0 16 } } }
	zero_threshold { ap_none {  { zero_threshold in_data 0 16 } } }
	current_level_read { ap_none {  { current_level_read in_data 0 16 } } }
	values_buffer { ap_memory {  { values_buffer_address0 mem_address 1 9 }  { values_buffer_ce0 mem_ce 1 1 }  { values_buffer_we0 mem_we 1 1 }  { values_buffer_d0 mem_din 1 16 } } }
}
