set SynModuleInfo {
  ...
  {SRCNAME guitar_effects_Pipeline_3 MODELNAME guitar_effects_Pipeline_3 RTLNAME guitar_effects_guitar_effects_Pipeline_3}
  ...
  {SRCNAME guitar_effects_Pipeline_WAH_LOOP MODELNAME guitar_effects_Pipeline_WAH_LOOP RTLNAME guitar_effects_guitar_effects_Pipeline_WAH_LOOP
    SUBMODULES {
