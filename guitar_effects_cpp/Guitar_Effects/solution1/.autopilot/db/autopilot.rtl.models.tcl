set SynModuleInfo {
  ...
  {SRCNAME compression MODELNAME compression RTLNAME guitar_effects_compression
    SUBMODULES {
      ...
      {MODELNAME guitar_effects_sdiv_16ns_16s_16_20_seq_1 RTLNAME guitar_effects_sdiv_16ns_16s_16_20_seq_1 BINDTYPE op TYPE sdiv IMPL auto_seq LATENCY 19 ALLOW_PRAGMA 1}
    }
  }
