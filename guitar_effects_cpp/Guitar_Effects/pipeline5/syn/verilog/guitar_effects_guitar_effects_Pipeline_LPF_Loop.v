...
reg   [8:0] i_reg_360;
wire   [0:0] icmp_ln173_fu_153_p2;
reg   [0:0] icmp_ln173_reg_365_pp0_iter1_reg;
reg   [31:0] compression_buffer_load_reg_384;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_state2_pp0_stage1_iter0;
wire    ap_block_state16_pp0_stage1_iter1;
wire    ap_block_state30_pp0_stage1_iter2;
wire    ap_block_pp0_stage1_11001;
reg   [31:0] lpf_coefficients_load_reg_389;
wire    ap_CS_fsm_pp0_stage6;
wire    ap_block_state7_pp0_stage6_iter0;
wire    ap_block_state21_pp0_stage6_iter1;
wire    ap_block_pp0_stage6_11001;
reg   [31:0] mul_i_reg_399;
reg   [31:0] dc_reg_404;
...
reg   [0:0] p_Result_s_reg_409;
wire    ap_CS_fsm_pp0_stage3;
wire    ap_block_state4_pp0_stage3_iter0;
wire    ap_block_state18_pp0_stage3_iter1;
wire    ap_block_state32_pp0_stage3_iter2;
wire    ap_block_pp0_stage3_11001;
wire   [22:0] p_Result_8_fu_224_p1;
reg   [22:0] p_Result_8_reg_414;
wire   [0:0] isNeg_fu_238_p3;
reg   [0:0] isNeg_reg_419;
wire   [8:0] ush_fu_256_p3;
reg   [8:0] ush_reg_424;
wire   [31:0] val_fu_318_p3;
reg   [31:0] val_reg_429;
...
wire   [63:0] zext_ln177_fu_194_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln173_fu_186_p1;
reg   [31:0] ret_fu_72;
wire   [31:0] result_V_fu_330_p3;
wire    ap_block_pp0_stage5_11001;
wire    ap_block_pp0_stage5;
wire    ap_loop_init;
wire    ap_block_pp0_stage6;
reg   [8:0] i_1_fu_76;
wire   [8:0] add_ln173_fu_159_p2;
...
wire   [10:0] zext_ln176_fu_165_p1;
wire  signed [10:0] sext_ln67_cast_fu_136_p1;
wire   [10:0] grp_fu_175_p0;
wire   [9:0] grp_fu_175_p1;
wire   [8:0] grp_fu_175_p2;
wire   [8:0] trunc_ln177_fu_190_p1;
wire    ap_block_pp0_stage3;
wire   [31:0] data_V_fu_203_p1;
wire   [7:0] xs_exp_V_fu_214_p4;
wire   [8:0] zext_ln346_fu_228_p1;
wire   [8:0] add_ln346_fu_232_p2;
wire   [7:0] sub_ln1512_fu_246_p2;
wire  signed [8:0] sext_ln1512_fu_252_p1;
wire    ap_block_pp0_stage4;
wire   [24:0] mantissa_fu_264_p4;
wire  signed [31:0] sext_ln1488_fu_277_p1;
wire   [78:0] zext_ln15_fu_273_p1;
wire   [78:0] zext_ln1488_fu_280_p1;
wire   [78:0] r_V_fu_284_p2;
wire   [0:0] tmp_fu_296_p3;
wire   [78:0] r_V_2_fu_290_p2;
wire   [31:0] zext_ln818_fu_304_p1;
wire   [31:0] tmp_s_fu_308_p4;
wire   [31:0] result_V_3_fu_325_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln173_fu_153_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        isNeg_reg_419 <= add_ln346_fu_232_p2[32'd8];
        p_Result_8_reg_414 <= p_Result_8_fu_224_p1;
        p_Result_s_reg_409 <= data_V_fu_203_p1[32'd31];
...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage7_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7)) | ((1'b0 == ap_block_pp0_stage11_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage11)))) begin
...
always @ (*) begin
    if (((icmp_ln173_reg_365 == 1'd1) & (1'b0 == ap_block_pp0_stage13_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage13))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage5_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage5) & (icmp_ln173_reg_365_pp0_iter1_reg == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage5_11001) & (1'b1 == ap_CS_fsm_pp0_stage5) & (icmp_ln173_reg_365_pp0_iter1_reg == 1'd1))) begin
        p_out_ap_vld = 1'b1;
    end else begin
        p_out_ap_vld = 1'b0;
    end
...
assign add_ln173_fu_159_p2 = (ap_sig_allocacmp_i + 9'd1);

assign add_ln346_fu_232_p2 = ($signed(zext_ln346_fu_228_p1) + $signed(9'd385));
...
assign compression_buffer_address0 = zext_ln177_fu_194_p1;

assign data_V_fu_203_p1 = dc_reg_404;

assign grp_fu_175_p0 = ($signed(zext_ln176_fu_165_p1) + $signed(sext_ln67_cast_fu_136_p1));

assign grp_fu_175_p1 = 11'd441;

assign grp_fu_2119_p_ce = 1'b1;

assign grp_fu_2119_p_din0 = reg_130;

assign grp_fu_2119_p_din1 = mul_i_reg_399;

assign grp_fu_2119_p_opcode = 2'd0;

assign grp_fu_594_p_ce = 1'b1;

assign grp_fu_594_p_din0 = reg_130;

assign grp_fu_594_p_din1 = lpf_coefficients_load_reg_389;

assign grp_fu_602_p_ce = 1'b1;

assign grp_fu_602_p_din0 = grp_fu_127_p0;

assign icmp_ln173_fu_153_p2 = ((ap_sig_allocacmp_i == 9'd441) ? 1'b1 : 1'b0);

assign isNeg_fu_238_p3 = add_ln346_fu_232_p2[32'd8];

assign lpf_coefficients_address0 = zext_ln173_fu_186_p1;

assign mantissa_fu_264_p4 = {{{{1'd1}, {p_Result_8_reg_414}}}, {1'd0}};

assign p_Result_8_fu_224_p1 = data_V_fu_203_p1[22:0];

assign p_out = ret_fu_72;

assign r_V_2_fu_290_p2 = zext_ln15_fu_273_p1 << zext_ln1488_fu_280_p1;

assign r_V_fu_284_p2 = zext_ln15_fu_273_p1 >> zext_ln1488_fu_280_p1;

assign result_V_3_fu_325_p2 = (32'd0 - val_reg_429);

assign result_V_fu_330_p3 = ((p_Result_s_reg_409[0:0] == 1'b1) ? result_V_3_fu_325_p2 : val_reg_429);

assign sext_ln1488_fu_277_p1 = $signed(ush_reg_424);

assign sext_ln1512_fu_252_p1 = $signed(sub_ln1512_fu_246_p2);

assign sext_ln67_cast_fu_136_p1 = $signed(sext_ln67);

assign sub_ln1512_fu_246_p2 = (8'd127 - xs_exp_V_fu_214_p4);

assign tmp_fu_296_p3 = r_V_fu_284_p2[32'd24];

assign tmp_s_fu_308_p4 = {{r_V_2_fu_290_p2[55:24]}};

assign trunc_ln177_fu_190_p1 = grp_fu_175_p2[8:0];

assign ush_fu_256_p3 = ((isNeg_fu_238_p3[0:0] == 1'b1) ? sext_ln1512_fu_252_p1 : add_ln346_fu_232_p2);

assign val_fu_318_p3 = ((isNeg_reg_419[0:0] == 1'b1) ? zext_ln818_fu_304_p1 : tmp_s_fu_308_p4);

assign xs_exp_V_fu_214_p4 = {{data_V_fu_203_p1[30:23]}};

assign zext_ln1488_fu_280_p1 = $unsigned(sext_ln1488_fu_277_p1);

assign zext_ln15_fu_273_p1 = mantissa_fu_264_p4;

assign zext_ln173_fu_186_p1 = i_reg_360;

assign zext_ln176_fu_165_p1 = ap_sig_allocacmp_i;

assign zext_ln177_fu_194_p1 = trunc_ln177_fu_190_p1;

assign zext_ln346_fu_228_p1 = xs_exp_V_fu_214_p4;

assign zext_ln818_fu_304_p1 = tmp_fu_296_p3;
