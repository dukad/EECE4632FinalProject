...
set C_modelArgList {
	{ zext_ln238 int 8 regular  }
	{ wah_values_buffer int 16 regular {array 100 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln238", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "wah_values_buffer", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln238", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "zext_ln238", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fadd_32ns_32ns_32_5_full_dsp_1_U23", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.srem_9ns_8ns_7_13_1_U26", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_5s_10ns_15_1_1_U27", "Parent" : "0"},
...
set Spec2ImplPortList { 
	zext_ln238 { ap_none {  { zext_ln238 in_data 0 8 } } }
	wah_values_buffer { ap_memory {  { wah_values_buffer_address0 mem_address 1 7 }  { wah_values_buffer_ce0 mem_ce 1 1 }  { wah_values_buffer_q0 mem_dout 0 16 } } }
