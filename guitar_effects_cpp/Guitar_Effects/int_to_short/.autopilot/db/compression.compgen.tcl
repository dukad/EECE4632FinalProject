...
set name guitar_effects_srem_17ns_10ns_16_21_seq_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {srem} IMPL {auto_seq} LATENCY 20 ALLOW_PRAGMA 1
}


set name guitar_effects_sdiv_32ns_16s_32_36_seq_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { values_buffer_address0 { O 9 vector } values_buffer_ce0 { O 1 bit } values_buffer_we0 { O 1 bit } values_buffer_d0 { O 16 vector } values_buffer_q0 { I 16 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    id 21 \
    name compression_buffer_index_read \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_compression_buffer_index_read \
    op interface \
    ports { compression_buffer_index_read { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_current_sample \
    op interface \
    ports { current_sample { I 32 vector } } \
} "
}
