...
extern "C" void guitar_effects(int*, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, char, int, __cosim_s1__, int, int, int, float, int, int, int, volatile void *, int);
extern "C" void apatb_guitar_effects_hw(volatile void * __xlx_apatb_param_INPUT_V_data_V, volatile void * __xlx_apatb_param_INPUT_V_keep_V, volatile void * __xlx_apatb_param_INPUT_V_strb_V, volatile void * __xlx_apatb_param_INPUT_V_user_V, volatile void * __xlx_apatb_param_INPUT_V_last_V, volatile void * __xlx_apatb_param_INPUT_V_id_V, volatile void * __xlx_apatb_param_INPUT_V_dest_V, volatile void * __xlx_apatb_param_OUTPUT_V_data_V, volatile void * __xlx_apatb_param_OUTPUT_V_keep_V, volatile void * __xlx_apatb_param_OUTPUT_V_strb_V, volatile void * __xlx_apatb_param_OUTPUT_V_user_V, volatile void * __xlx_apatb_param_OUTPUT_V_last_V, volatile void * __xlx_apatb_param_OUTPUT_V_id_V, volatile void * __xlx_apatb_param_OUTPUT_V_dest_V, volatile void * __xlx_apatb_param_axilite_out, char __xlx_apatb_param_control, int __xlx_apatb_param_distortion_threshold, __cosim_s1__* __xlx_apatb_param_distortion_clip_factor, int __xlx_apatb_param_compression_min_threshold, int __xlx_apatb_param_compression_max_threshold, int __xlx_apatb_param_compression_zero_threshold, float __xlx_apatb_param_delay_mult, int __xlx_apatb_param_delay_samples, int __xlx_apatb_param_tempo, volatile void * __xlx_apatb_param_wah_coeffs, volatile void * __xlx_apatb_param_debug_output, int __xlx_apatb_param_starting_sample) {
  ...
  vector<sc_bv<32> >__xlx_wah_coeffs__tmp_vec;
  for (int j = 0, e = 1000; j != e; ++j) {
    sc_bv<32> _xlx_tmp_sc;
    _xlx_tmp_sc.range(7, 0) = ((char*)__xlx_apatb_param_wah_coeffs)[j*4+0];
    _xlx_tmp_sc.range(15, 8) = ((char*)__xlx_apatb_param_wah_coeffs)[j*4+1];
    _xlx_tmp_sc.range(23, 16) = ((char*)__xlx_apatb_param_wah_coeffs)[j*4+2];
    _xlx_tmp_sc.range(31, 24) = ((char*)__xlx_apatb_param_wah_coeffs)[j*4+3];
    __xlx_wah_coeffs__tmp_vec.push_back(_xlx_tmp_sc);
  }
  int __xlx_size_param_wah_coeffs = 1000;
  int __xlx_offset_param_wah_coeffs = 0;
  int __xlx_offset_byte_param_wah_coeffs = 0*4;
  int* __xlx_wah_coeffs__input_buffer= new int[__xlx_wah_coeffs__tmp_vec.size()];
  for (int i = 0; i < __xlx_wah_coeffs__tmp_vec.size(); ++i) {
    __xlx_wah_coeffs__input_buffer[i] = __xlx_wah_coeffs__tmp_vec[i].range(31, 0).to_uint64();
  }
...
// print __xlx_apatb_param_wah_coeffs
  ...
  for (int i = 0; i < __xlx_size_param_wah_coeffs; ++i) {
    ((char*)__xlx_apatb_param_wah_coeffs)[i*4+0] = __xlx_wah_coeffs_output_buffer[i].range(7, 0).to_uint();
    ((char*)__xlx_apatb_param_wah_coeffs)[i*4+1] = __xlx_wah_coeffs_output_buffer[i].range(15, 8).to_uint();
    ((char*)__xlx_apatb_param_wah_coeffs)[i*4+2] = __xlx_wah_coeffs_output_buffer[i].range(23, 16).to_uint();
    ((char*)__xlx_apatb_param_wah_coeffs)[i*4+3] = __xlx_wah_coeffs_output_buffer[i].range(31, 24).to_uint();
  }
