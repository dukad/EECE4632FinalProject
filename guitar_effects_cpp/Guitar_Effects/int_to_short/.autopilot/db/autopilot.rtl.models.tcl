set SynModuleInfo {
  {SRCNAME compression_Pipeline_LPF_Loop MODELNAME compression_Pipeline_LPF_Loop RTLNAME guitar_effects_compression_Pipeline_LPF_Loop
    SUBMODULES {
      ...
      {MODELNAME guitar_effects_mul_mul_8ns_16s_24_4_1 RTLNAME guitar_effects_mul_mul_8ns_16s_24_4_1 BINDTYPE op TYPE all IMPL dsp48 LATENCY 3 ALLOW_PRAGMA 1}
      {MODELNAME guitar_effects_compression_Pipeline_LPF_Loop_lpf_coefficients_ROM_AUTO_1R RTLNAME guitar_effects_compression_Pipeline_LPF_Loop_lpf_coefficients_ROM_AUTO_1R BINDTYPE storage TYPE rom IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
  ...
  {SRCNAME compression MODELNAME compression RTLNAME guitar_effects_compression
    SUBMODULES {
      {MODELNAME guitar_effects_srem_17ns_10ns_16_21_seq_1 RTLNAME guitar_effects_srem_17ns_10ns_16_21_seq_1 BINDTYPE op TYPE srem IMPL auto_seq LATENCY 20 ALLOW_PRAGMA 1}
      {MODELNAME guitar_effects_sdiv_32ns_16s_32_36_seq_1 RTLNAME guitar_effects_sdiv_32ns_16s_32_36_seq_1 BINDTYPE op TYPE sdiv IMPL auto_seq LATENCY 35 ALLOW_PRAGMA 1}
    }
  }
  ...
  {SRCNAME wah MODELNAME wah RTLNAME guitar_effects_wah
    SUBMODULES {
      ...
      {MODELNAME guitar_effects_srem_17ns_8ns_8_21_seq_1 RTLNAME guitar_effects_srem_17ns_8ns_8_21_seq_1 BINDTYPE op TYPE srem IMPL auto_seq LATENCY 20 ALLOW_PRAGMA 1}
