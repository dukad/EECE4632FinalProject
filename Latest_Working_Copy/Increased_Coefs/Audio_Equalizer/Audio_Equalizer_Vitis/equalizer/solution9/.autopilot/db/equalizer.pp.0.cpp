...
__attribute__((sdx_kernel("equalizer", 0))) void equalizer(hls::stream<AXI_VAL>& output, coef_t coefs[99], hls::stream<AXI_VAL>& input) {
#line 16 "C:/Users/a01me/Documents/GitHub/College/EECE4632FinalProject/Increased_Coefs/Audio_Equalizer/Audio_Equalizer_Vitis/equalizer/solution9/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=equalizer
# 3 "equalizer.cpp"

#line 6 "C:/Users/a01me/Documents/GitHub/College/EECE4632FinalProject/Increased_Coefs/Audio_Equalizer/Audio_Equalizer_Vitis/equalizer/solution9/directives.tcl"
#pragma HLSDIRECTIVE TOP name=equalizer
# 3 "equalizer.cpp"
 ...
 while(running){
  ...
  switch (state){
   ...
   case 0x0011:
    Coef_Read_Loop:
    for (j = 3 - 1; j > 0; j--){
     VITIS_LOOP_39_1: for (i = 99 - 1; i > 0; i--){
#pragma HLS PIPELINE
