...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 5 \
    name signal_shift_reg \
    reset_level 1 \
    sync_rst true \
    dir IO \
    corename signal_shift_reg \
    op interface \
    ports { signal_shift_reg_address0 { O 7 vector } signal_shift_reg_ce0 { O 1 bit } signal_shift_reg_we0 { O 1 bit } signal_shift_reg_d0 { O 32 vector } signal_shift_reg_address1 { O 7 vector } signal_shift_reg_ce1 { O 1 bit } signal_shift_reg_q1 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'signal_shift_reg'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_accumulate_out \
    op interface \
    ports { accumulate_out { O 32 vector } accumulate_out_ap_vld { O 1 bit } } \
} "
}
