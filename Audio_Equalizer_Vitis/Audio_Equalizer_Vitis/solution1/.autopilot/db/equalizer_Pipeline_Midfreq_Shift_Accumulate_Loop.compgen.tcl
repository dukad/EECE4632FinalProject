...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 10 \
    name midfreq_shift_reg \
    reset_level 1 \
    sync_rst true \
    dir IO \
    corename midfreq_shift_reg \
    op interface \
    ports { midfreq_shift_reg_address0 { O 6 vector } midfreq_shift_reg_ce0 { O 1 bit } midfreq_shift_reg_we0 { O 1 bit } midfreq_shift_reg_d0 { O 32 vector } midfreq_shift_reg_address1 { O 6 vector } midfreq_shift_reg_ce1 { O 1 bit } midfreq_shift_reg_q1 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'midfreq_shift_reg'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_midfreq_coefs \
    op interface \
    ports { midfreq_coefs { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 9 \
    name midfreq_accumulate_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_midfreq_accumulate_out \
    op interface \
    ports { midfreq_accumulate_out { O 32 vector } midfreq_accumulate_out_ap_vld { O 1 bit } } \
} "
}
