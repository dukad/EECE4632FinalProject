...
define void @apatb_equalizer_ir(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* noalias nonnull dereferenceable(12) %SIGNAL_IN, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* noalias nonnull dereferenceable(12) %SIGNAL_OUT, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="63" %coefs) local_unnamed_addr #0 {
entry:
  %SIGNAL_IN_copy.data = alloca i32
  %SIGNAL_IN_copy.keep = alloca i4
  %SIGNAL_IN_copy.strb = alloca i4
  %SIGNAL_IN_copy.user = alloca i1
  %SIGNAL_IN_copy.last = alloca i1
  %SIGNAL_IN_copy.id = alloca i1
  %SIGNAL_IN_copy.dest = alloca i1
  %SIGNAL_OUT_copy.data = alloca i32
  %SIGNAL_OUT_copy.keep = alloca i4
  %SIGNAL_OUT_copy.strb = alloca i4
  %SIGNAL_OUT_copy.user = alloca i1
  %SIGNAL_OUT_copy.last = alloca i1
  %SIGNAL_OUT_copy.id = alloca i1
  %SIGNAL_OUT_copy.dest = alloca i1
  %coefs_copy = alloca [63 x i32], align 512
  %0 = bitcast i32* %coefs to [63 x i32]*
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* nonnull %SIGNAL_IN, i32* %SIGNAL_IN_copy.data, i4* %SIGNAL_IN_copy.keep, i4* %SIGNAL_IN_copy.strb, i1* %SIGNAL_IN_copy.user, i1* %SIGNAL_IN_copy.last, i1* %SIGNAL_IN_copy.id, i1* %SIGNAL_IN_copy.dest, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* nonnull %SIGNAL_OUT, i32* %SIGNAL_OUT_copy.data, i4* %SIGNAL_OUT_copy.keep, i4* %SIGNAL_OUT_copy.strb, i1* %SIGNAL_OUT_copy.user, i1* %SIGNAL_OUT_copy.last, i1* %SIGNAL_OUT_copy.id, i1* %SIGNAL_OUT_copy.dest, [63 x i32]* nonnull %0, [63 x i32]* nonnull align 512 %coefs_copy)
  call void @apatb_equalizer_hw(i32* %SIGNAL_IN_copy.data, i4* %SIGNAL_IN_copy.keep, i4* %SIGNAL_IN_copy.strb, i1* %SIGNAL_IN_copy.user, i1* %SIGNAL_IN_copy.last, i1* %SIGNAL_IN_copy.id, i1* %SIGNAL_IN_copy.dest, i32* %SIGNAL_OUT_copy.data, i4* %SIGNAL_OUT_copy.keep, i4* %SIGNAL_OUT_copy.strb, i1* %SIGNAL_OUT_copy.user, i1* %SIGNAL_OUT_copy.last, i1* %SIGNAL_OUT_copy.id, i1* %SIGNAL_OUT_copy.dest, [63 x i32]* %coefs_copy)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* %SIGNAL_IN, i32* %SIGNAL_IN_copy.data, i4* %SIGNAL_IN_copy.keep, i4* %SIGNAL_IN_copy.strb, i1* %SIGNAL_IN_copy.user, i1* %SIGNAL_IN_copy.last, i1* %SIGNAL_IN_copy.id, i1* %SIGNAL_IN_copy.dest, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* %SIGNAL_OUT, i32* %SIGNAL_OUT_copy.data, i4* %SIGNAL_OUT_copy.keep, i4* %SIGNAL_OUT_copy.strb, i1* %SIGNAL_OUT_copy.user, i1* %SIGNAL_OUT_copy.last, i1* %SIGNAL_OUT_copy.id, i1* %SIGNAL_OUT_copy.dest, [63 x i32]* %0, [63 x i32]* %coefs_copy)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* noalias, i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.0" %_V_data_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.1" %_V_keep_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.2" %_V_strb_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.3" %_V_user_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.4" %_V_last_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.5" %_V_id_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* noalias, i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.0" %_V_data_V1, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.1" %_V_keep_V2, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.2" %_V_strb_V3, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.3" %_V_user_V4, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.4" %_V_last_V5, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.5" %_V_id_V6, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.6" %_V_dest_V7, [63 x i32]* noalias readonly, [63 x i32]* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #1 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>.13"(i32* %_V_data_V, i4* %_V_keep_V, i4* %_V_strb_V, i1* %_V_user_V, i1* %_V_last_V, i1* %_V_id_V, i1* %_V_dest_V, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>.13"(i32* %_V_data_V1, i4* %_V_keep_V2, i4* %_V_strb_V3, i1* %_V_user_V4, i1* %_V_last_V5, i1* %_V_id_V6, i1* %_V_dest_V7, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* %1)
  call fastcc void @onebyonecpy_hls.p0a63i32([63 x i32]* align 512 %3, [63 x i32]* %2)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @onebyonecpy_hls.p0a63i32([63 x i32]* noalias align 512 "fpga.caller.interfaces"="layout_transformed", [63 x i32]* noalias readonly "fpga.caller.interfaces"="layout_transformed") unnamed_addr #2 {
entry:
  %2 = icmp eq [63 x i32]* %0, null
  %3 = icmp eq [63 x i32]* %1, null
  %4 = or i1 %2, %3
...
for.loop:                                         ; preds = %for.loop, %copy
  ...
  %dst.addr = getelementptr [63 x i32], [63 x i32]* %0, i64 0, i64 %for.loop.idx1
  %src.addr = getelementptr [63 x i32], [63 x i32]* %1, i64 0, i64 %for.loop.idx1
  %5 = load i32, i32* %src.addr, align 4
  store i32 %5, i32* %dst.addr, align 4
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx1, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, 63
...
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a63i32([63 x i32]* %2, [63 x i32]* align 512 %3)
  ret void
}
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>.9"(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* nonnull align 512 %0, i32* %_V_data_V, i4* %_V_keep_V, i4* %_V_strb_V, i1* %_V_user_V, i1* %_V_last_V, i1* %_V_id_V, i1* %_V_dest_V)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>.9"(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed", i32* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.0" %_V_data_V, i4* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.1" %_V_keep_V, i4* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.2" %_V_strb_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.3" %_V_user_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.4" %_V_last_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.5" %_V_id_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.6" %_V_dest_V) unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>.13"(i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.0" %_V_data_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.1" %_V_keep_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.2" %_V_strb_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.3" %_V_user_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.4" %_V_last_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.5" %_V_id_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* noalias "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
  %1 = icmp eq %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* %0, null
  %2 = or i1 false, %1
  br i1 %2, label %ret, label %copy
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>.16"(i32* %_V_data_V, i4* %_V_keep_V, i4* %_V_strb_V, i1* %_V_user_V, i1* %_V_last_V, i1* %_V_id_V, i1* %_V_dest_V, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* nonnull %0)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>.16"(i32* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.0" %_V_data_V, i4* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.1" %_V_keep_V, i4* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.2" %_V_strb_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.3" %_V_user_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.4" %_V_last_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.5" %_V_id_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
  %1 = alloca %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"
...
declare void @apatb_equalizer_hw(i32*, i4*, i4*, i1*, i1*, i1*, i1*, i32*, i4*, i4*, i1*, i1*, i1*, i1*, [63 x i32]*)
...
define void @equalizer_hw_stub_wrapper(i32*, i4*, i4*, i1*, i1*, i1*, i1*, i32*, i4*, i4*, i1*, i1*, i1*, i1*, [63 x i32]*) #6 {
entry:
  %15 = alloca %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"
  %16 = alloca %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"
  call void @copy_out(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* %15, i32* %0, i4* %1, i4* %2, i1* %3, i1* %4, i1* %5, i1* %6, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* %16, i32* %7, i4* %8, i4* %9, i1* %10, i1* %11, i1* %12, i1* %13, [63 x i32]* null, [63 x i32]* %14)
  %17 = bitcast [63 x i32]* %14 to i32*
  call void @equalizer_hw_stub(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* %15, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* %16, i32* %17)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* %15, i32* %0, i4* %1, i4* %2, i1* %3, i1* %4, i1* %5, i1* %6, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"* %16, i32* %7, i4* %8, i4* %9, i1* %10, i1* %11, i1* %12, i1* %13, [63 x i32]* null, [63 x i32]* %14)
  ret void
}

declare void @equalizer_hw_stub(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"*, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1>, 0>"*, i32*)
