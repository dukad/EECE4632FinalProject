...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 5 \
    name lowfreq_shift_reg \
    reset_level 1 \
    sync_rst true \
    dir IO \
    corename lowfreq_shift_reg \
    op interface \
    ports { lowfreq_shift_reg_address0 { O 6 vector } lowfreq_shift_reg_ce0 { O 1 bit } lowfreq_shift_reg_we0 { O 1 bit } lowfreq_shift_reg_d0 { O 32 vector } lowfreq_shift_reg_address1 { O 6 vector } lowfreq_shift_reg_ce1 { O 1 bit } lowfreq_shift_reg_q1 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'lowfreq_shift_reg'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_lowfreq_coefs \
    op interface \
    ports { lowfreq_coefs { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 4 \
    name lowfreq_accumulate_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_lowfreq_accumulate_out \
    op interface \
    ports { lowfreq_accumulate_out { O 32 vector } lowfreq_accumulate_out_ap_vld { O 1 bit } } \
} "
}
