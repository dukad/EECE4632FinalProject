...
extern "C" void equalizer(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, int*, int*, int*);
...
auto* sSIGNAL_OUT_V_dest_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_SIGNAL_OUT_V_dest_V);
  // Collect __xlx_lowpass_coefs__tmp_vec
  vector<sc_bv<32> >__xlx_lowpass_coefs__tmp_vec;
  for (int j = 0, e = 33; j != e; ++j) {
    sc_bv<32> _xlx_tmp_sc;
    _xlx_tmp_sc.range(7, 0) = ((char*)__xlx_apatb_param_lowpass_coefs)[j*4+0];
    _xlx_tmp_sc.range(15, 8) = ((char*)__xlx_apatb_param_lowpass_coefs)[j*4+1];
    _xlx_tmp_sc.range(23, 16) = ((char*)__xlx_apatb_param_lowpass_coefs)[j*4+2];
    _xlx_tmp_sc.range(31, 24) = ((char*)__xlx_apatb_param_lowpass_coefs)[j*4+3];
    __xlx_lowpass_coefs__tmp_vec.push_back(_xlx_tmp_sc);
  }
  int __xlx_size_param_lowpass_coefs = 33;
  int __xlx_offset_param_lowpass_coefs = 0;
  int __xlx_offset_byte_param_lowpass_coefs = 0*4;
  int* __xlx_lowpass_coefs__input_buffer= new int[__xlx_lowpass_coefs__tmp_vec.size()];
  for (int i = 0; i < __xlx_lowpass_coefs__tmp_vec.size(); ++i) {
    __xlx_lowpass_coefs__input_buffer[i] = __xlx_lowpass_coefs__tmp_vec[i].range(31, 0).to_uint64();
  }
  // Collect __xlx_bandpass_coefs__tmp_vec
  vector<sc_bv<32> >__xlx_bandpass_coefs__tmp_vec;
  for (int j = 0, e = 33; j != e; ++j) {
    sc_bv<32> _xlx_tmp_sc;
    _xlx_tmp_sc.range(7, 0) = ((char*)__xlx_apatb_param_bandpass_coefs)[j*4+0];
    _xlx_tmp_sc.range(15, 8) = ((char*)__xlx_apatb_param_bandpass_coefs)[j*4+1];
    _xlx_tmp_sc.range(23, 16) = ((char*)__xlx_apatb_param_bandpass_coefs)[j*4+2];
    _xlx_tmp_sc.range(31, 24) = ((char*)__xlx_apatb_param_bandpass_coefs)[j*4+3];
    __xlx_bandpass_coefs__tmp_vec.push_back(_xlx_tmp_sc);
  }
  int __xlx_size_param_bandpass_coefs = 33;
  int __xlx_offset_param_bandpass_coefs = 0;
  int __xlx_offset_byte_param_bandpass_coefs = 0*4;
  int* __xlx_bandpass_coefs__input_buffer= new int[__xlx_bandpass_coefs__tmp_vec.size()];
  for (int i = 0; i < __xlx_bandpass_coefs__tmp_vec.size(); ++i) {
    __xlx_bandpass_coefs__input_buffer[i] = __xlx_bandpass_coefs__tmp_vec[i].range(31, 0).to_uint64();
  }
  // Collect __xlx_highpass_coefs__tmp_vec
  vector<sc_bv<32> >__xlx_highpass_coefs__tmp_vec;
  for (int j = 0, e = 33; j != e; ++j) {
    sc_bv<32> _xlx_tmp_sc;
    _xlx_tmp_sc.range(7, 0) = ((char*)__xlx_apatb_param_highpass_coefs)[j*4+0];
    _xlx_tmp_sc.range(15, 8) = ((char*)__xlx_apatb_param_highpass_coefs)[j*4+1];
    _xlx_tmp_sc.range(23, 16) = ((char*)__xlx_apatb_param_highpass_coefs)[j*4+2];
    _xlx_tmp_sc.range(31, 24) = ((char*)__xlx_apatb_param_highpass_coefs)[j*4+3];
    __xlx_highpass_coefs__tmp_vec.push_back(_xlx_tmp_sc);
  }
  int __xlx_size_param_highpass_coefs = 33;
  int __xlx_offset_param_highpass_coefs = 0;
  int __xlx_offset_byte_param_highpass_coefs = 0*4;
  int* __xlx_highpass_coefs__input_buffer= new int[__xlx_highpass_coefs__tmp_vec.size()];
  for (int i = 0; i < __xlx_highpass_coefs__tmp_vec.size(); ++i) {
    __xlx_highpass_coefs__input_buffer[i] = __xlx_highpass_coefs__tmp_vec[i].range(31, 0).to_uint64();
  }
  // DUT call
  equalizer(sSIGNAL_IN_V_data_V->data<int>(), sSIGNAL_IN_V_keep_V->data<char>(), sSIGNAL_IN_V_strb_V->data<char>(), sSIGNAL_IN_V_user_V->data<char>(), sSIGNAL_IN_V_last_V->data<char>(), sSIGNAL_IN_V_id_V->data<char>(), sSIGNAL_IN_V_dest_V->data<char>(), sSIGNAL_OUT_V_data_V->data<int>(), sSIGNAL_OUT_V_keep_V->data<char>(), sSIGNAL_OUT_V_strb_V->data<char>(), sSIGNAL_OUT_V_user_V->data<char>(), sSIGNAL_OUT_V_last_V->data<char>(), sSIGNAL_OUT_V_id_V->data<char>(), sSIGNAL_OUT_V_dest_V->data<char>(), __xlx_lowpass_coefs__input_buffer, __xlx_bandpass_coefs__input_buffer, __xlx_highpass_coefs__input_buffer);
...
// print __xlx_apatb_param_lowpass_coefs
  sc_bv<32>*__xlx_lowpass_coefs_output_buffer = new sc_bv<32>[__xlx_size_param_lowpass_coefs];
  for (int i = 0; i < __xlx_size_param_lowpass_coefs; ++i) {
    __xlx_lowpass_coefs_output_buffer[i] = __xlx_lowpass_coefs__input_buffer[i+__xlx_offset_param_lowpass_coefs];
  }
  for (int i = 0; i < __xlx_size_param_lowpass_coefs; ++i) {
    ((char*)__xlx_apatb_param_lowpass_coefs)[i*4+0] = __xlx_lowpass_coefs_output_buffer[i].range(7, 0).to_uint();
    ((char*)__xlx_apatb_param_lowpass_coefs)[i*4+1] = __xlx_lowpass_coefs_output_buffer[i].range(15, 8).to_uint();
    ((char*)__xlx_apatb_param_lowpass_coefs)[i*4+2] = __xlx_lowpass_coefs_output_buffer[i].range(23, 16).to_uint();
    ((char*)__xlx_apatb_param_lowpass_coefs)[i*4+3] = __xlx_lowpass_coefs_output_buffer[i].range(31, 24).to_uint();
  }
// print __xlx_apatb_param_bandpass_coefs
  sc_bv<32>*__xlx_bandpass_coefs_output_buffer = new sc_bv<32>[__xlx_size_param_bandpass_coefs];
  for (int i = 0; i < __xlx_size_param_bandpass_coefs; ++i) {
    __xlx_bandpass_coefs_output_buffer[i] = __xlx_bandpass_coefs__input_buffer[i+__xlx_offset_param_bandpass_coefs];
  }
  for (int i = 0; i < __xlx_size_param_bandpass_coefs; ++i) {
    ((char*)__xlx_apatb_param_bandpass_coefs)[i*4+0] = __xlx_bandpass_coefs_output_buffer[i].range(7, 0).to_uint();
    ((char*)__xlx_apatb_param_bandpass_coefs)[i*4+1] = __xlx_bandpass_coefs_output_buffer[i].range(15, 8).to_uint();
    ((char*)__xlx_apatb_param_bandpass_coefs)[i*4+2] = __xlx_bandpass_coefs_output_buffer[i].range(23, 16).to_uint();
    ((char*)__xlx_apatb_param_bandpass_coefs)[i*4+3] = __xlx_bandpass_coefs_output_buffer[i].range(31, 24).to_uint();
  }
// print __xlx_apatb_param_highpass_coefs
  sc_bv<32>*__xlx_highpass_coefs_output_buffer = new sc_bv<32>[__xlx_size_param_highpass_coefs];
  for (int i = 0; i < __xlx_size_param_highpass_coefs; ++i) {
    __xlx_highpass_coefs_output_buffer[i] = __xlx_highpass_coefs__input_buffer[i+__xlx_offset_param_highpass_coefs];
  }
  for (int i = 0; i < __xlx_size_param_highpass_coefs; ++i) {
    ((char*)__xlx_apatb_param_highpass_coefs)[i*4+0] = __xlx_highpass_coefs_output_buffer[i].range(7, 0).to_uint();
    ((char*)__xlx_apatb_param_highpass_coefs)[i*4+1] = __xlx_highpass_coefs_output_buffer[i].range(15, 8).to_uint();
    ((char*)__xlx_apatb_param_highpass_coefs)[i*4+2] = __xlx_highpass_coefs_output_buffer[i].range(23, 16).to_uint();
    ((char*)__xlx_apatb_param_highpass_coefs)[i*4+3] = __xlx_highpass_coefs_output_buffer[i].range(31, 24).to_uint();
  }
}
