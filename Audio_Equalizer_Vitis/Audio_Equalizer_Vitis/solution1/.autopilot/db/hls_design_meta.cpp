...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("SIGNAL_IN_TDATA", 32, hls_in, 1, "axis", "in_data", 1),
	Port_Property("SIGNAL_IN_TVALID", 1, hls_in, 7, "axis", "in_vld", 1),
	Port_Property("SIGNAL_IN_TREADY", 1, hls_out, 7, "axis", "in_acc", 1),
	Port_Property("SIGNAL_IN_TKEEP", 4, hls_in, 2, "axis", "in_data", 1),
	Port_Property("SIGNAL_IN_TSTRB", 4, hls_in, 3, "axis", "in_data", 1),
	Port_Property("SIGNAL_IN_TUSER", 2, hls_in, 4, "axis", "in_data", 1),
	Port_Property("SIGNAL_IN_TLAST", 1, hls_in, 5, "axis", "in_data", 1),
	Port_Property("SIGNAL_IN_TID", 5, hls_in, 6, "axis", "in_data", 1),
	Port_Property("SIGNAL_IN_TDEST", 6, hls_in, 7, "axis", "in_data", 1),
	Port_Property("SIGNAL_OUT_TDATA", 32, hls_out, 8, "axis", "out_data", 1),
	Port_Property("SIGNAL_OUT_TVALID", 1, hls_out, 14, "axis", "out_vld", 1),
	Port_Property("SIGNAL_OUT_TREADY", 1, hls_in, 14, "axis", "out_acc", 1),
	Port_Property("SIGNAL_OUT_TKEEP", 4, hls_out, 9, "axis", "out_data", 1),
	Port_Property("SIGNAL_OUT_TSTRB", 4, hls_out, 10, "axis", "out_data", 1),
	Port_Property("SIGNAL_OUT_TUSER", 2, hls_out, 11, "axis", "out_data", 1),
	Port_Property("SIGNAL_OUT_TLAST", 1, hls_out, 12, "axis", "out_data", 1),
	Port_Property("SIGNAL_OUT_TID", 5, hls_out, 13, "axis", "out_data", 1),
	Port_Property("SIGNAL_OUT_TDEST", 6, hls_out, 14, "axis", "out_data", 1),
