...
__attribute__((sdx_kernel("equalizer", 0))) void equalizer(hls::stream< ap_axis<32,2,5,6> > &SIGNAL_IN,
    ...
    coef_t lowpass_coefs[33],
    coef_t bandpass_coefs[33],
    coef_t highpass_coefs[33]){
...
#pragma HLS INTERFACE axis port=SIGNAL_OUT
 ...
 static data_t lowpass_shift_reg[33];
    static data_t bandpass_shift_reg[33];
    static data_t highpass_shift_reg[33];
