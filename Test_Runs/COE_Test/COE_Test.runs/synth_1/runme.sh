...
HD_PWD='C:/EECE4632FinalProject/Test_Runs/COE_Test/COE_Test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log COE_Test_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source COE_Test_wrapper.tcl
