...
HD_PWD='C:/EECE4632FinalProject/Test_Runs/COE_Test/COE_Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log COE_Test_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source COE_Test_wrapper.tcl -notrace
