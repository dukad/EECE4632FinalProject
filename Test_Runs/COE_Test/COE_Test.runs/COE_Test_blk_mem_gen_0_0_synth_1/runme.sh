...
HD_PWD='C:/EECE4632FinalProject/Test_Runs/COE_Test/COE_Test.runs/COE_Test_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log COE_Test_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source COE_Test_blk_mem_gen_0_0.tcl
