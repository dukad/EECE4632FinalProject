...
HD_PWD='C:/Users/a01me/Documents/GitHub/College/EECE4632FinalProject/Test_Runs/FIR_Testing/FIR_Test_Vivado/FIR_Test_Vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_Test_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIR_Test_wrapper.tcl
