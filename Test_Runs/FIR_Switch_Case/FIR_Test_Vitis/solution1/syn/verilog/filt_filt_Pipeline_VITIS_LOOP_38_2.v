...
module filt_filt_Pipeline_VITIS_LOOP_38_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_idle_pp0;
wire   [0:0] icmp_ln39_fu_193_p2;
reg    ap_block_state2_pp0_stage0_iter1;
reg   [0:0] icmp_ln39_reg_286;
reg    ap_block_state3_io;
reg   [0:0] icmp_ln39_reg_286_pp0_iter2_reg;
reg    ap_block_state4_io;
reg   [0:0] icmp_ln39_reg_286_pp0_iter7_reg;
...
reg   [0:0] icmp_ln39_reg_286_pp0_iter3_reg;
reg   [0:0] icmp_ln39_reg_286_pp0_iter4_reg;
reg   [0:0] icmp_ln39_reg_286_pp0_iter5_reg;
reg   [0:0] icmp_ln39_reg_286_pp0_iter6_reg;
...
wire    ap_loop_init;
wire  signed [63:0] sext_ln45_fu_223_p1;
reg    ap_block_pp0_stage0_01001;
reg   [31:0] tmp_data_1_fu_92;
reg   [63:0] i_fu_96;
wire   [63:0] add_ln48_fu_241_p2;
wire  signed [63:0] sext_ln38_cast_fu_176_p1;
wire   [63:0] shl_ln45_fu_202_p2;
wire   [63:0] add_ln45_fu_208_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        end else if (((icmp_ln39_fu_193_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((ap_enable_reg_pp0_iter8 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln39_reg_286_pp0_iter7_reg == 1'd0))) begin
...
always @ (*) begin
    if (((icmp_ln39_fu_193_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter8 == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (icmp_ln39_reg_286_pp0_iter7_reg == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (icmp_ln39_reg_286 == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter3 == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (icmp_ln39_reg_286_pp0_iter2_reg == 1'd0))) begin
...
always @ (*) begin
    if (((icmp_ln39_fu_193_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln39_fu_193_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        input_r_TREADY = 1'b1;
    end else begin
        input_r_TREADY = 1'b0;
    end
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln39_reg_286 == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter8 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln39_reg_286_pp0_iter7_reg == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter3 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln39_reg_286_pp0_iter2_reg == 1'd0))) begin
...
always @ (*) begin
    if (((icmp_ln39_reg_286_pp0_iter6_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
assign add_ln45_fu_208_p2 = (shl_ln45_fu_202_p2 + coefs);

assign add_ln48_fu_241_p2 = (i_fu_96 + 64'd1);
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln39_fu_193_p2 == 1'd0) & (input_r_TVALID == 1'b0));
end

always @ (*) begin
    ap_block_state3_io = ((m_axi_gmem_AWREADY == 1'b0) & (icmp_ln39_reg_286 == 1'd0));
end

always @ (*) begin
    ap_block_state4_io = ((m_axi_gmem_WREADY == 1'b0) & (icmp_ln39_reg_286_pp0_iter2_reg == 1'd0));
end

always @ (*) begin
    ap_block_state9_pp0_stage0_iter8 = ((icmp_ln39_reg_286_pp0_iter7_reg == 1'd0) & (m_axi_gmem_BVALID == 1'b0));
end
...
assign icmp_ln39_fu_193_p2 = ((tmp_data_1_fu_92 == 32'd43962) ? 1'b1 : 1'b0);
...
assign sext_ln38_cast_fu_176_p1 = $signed(sext_ln38);

assign sext_ln45_fu_223_p1 = $signed(trunc_ln1_fu_213_p4);

assign shl_ln45_fu_202_p2 = i_fu_96 << 64'd2;

assign tmp_last_out = ap_phi_mux_tmp_last_phi_fu_169_p4;

assign trunc_ln1_fu_213_p4 = {{add_ln45_fu_208_p2[63:2]}};

endmodule //filt_filt_Pipeline_VITIS_LOOP_38_2
