...
define void @apatb_filt_ir(%"class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"* noalias nonnull dereferenceable(8) %y, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="11" "maxi" %c, %"class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"* noalias nonnull dereferenceable(8) %x) local_unnamed_addr #0 {
entry:
  ...
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"* nonnull %y, i16* nonnull align 512 %y_copy.data, i2* nonnull align 512 %y_copy.keep, i2* nonnull align 512 %y_copy.strb, i1* nonnull align 512 %y_copy.user, i1* nonnull align 512 %y_copy.last, i1* nonnull align 512 %y_copy.id, i1* nonnull align 512 %y_copy.dest, [11 x i32]* nonnull %0, [11 x i32]* nonnull align 512 %c_copy, %"class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"* nonnull %x, i16* nonnull align 512 %x_copy.data, i2* nonnull align 512 %x_copy.keep, i2* nonnull align 512 %x_copy.strb, i1* nonnull align 512 %x_copy.user, i1* nonnull align 512 %x_copy.last, i1* nonnull align 512 %x_copy.id, i1* nonnull align 512 %x_copy.dest)
  call void @apatb_filt_hw(i16* %y_copy.data, i2* %y_copy.keep, i2* %y_copy.strb, i1* %y_copy.user, i1* %y_copy.last, i1* %y_copy.id, i1* %y_copy.dest, [11 x i32]* %c_copy, i16* %x_copy.data, i2* %x_copy.keep, i2* %x_copy.strb, i1* %x_copy.user, i1* %x_copy.last, i1* %x_copy.id, i1* %x_copy.dest)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"* %y, i16* %y_copy.data, i2* %y_copy.keep, i2* %y_copy.strb, i1* %y_copy.user, i1* %y_copy.last, i1* %y_copy.id, i1* %y_copy.dest, [11 x i32]* %0, [11 x i32]* %c_copy, %"class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"* %x, i16* %x_copy.data, i2* %x_copy.keep, i2* %x_copy.strb, i1* %x_copy.user, i1* %x_copy.last, i1* %x_copy.id, i1* %x_copy.dest)
  ret void
}

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"* noalias, i16* noalias align 512 "unpacked"="1.0" %_V_data_V, i2* noalias align 512 "unpacked"="1.1" %_V_keep_V, i2* noalias align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %_V_user_V, i1* noalias align 512 "unpacked"="1.4" %_V_last_V, i1* noalias align 512 "unpacked"="1.5" %_V_id_V, i1* noalias align 512 "unpacked"="1.6" %_V_dest_V, [11 x i32]* noalias readonly, [11 x i32]* noalias align 512, %"class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"* noalias, i16* noalias align 512 "unpacked"="11.0" %_V_data_V1, i2* noalias align 512 "unpacked"="11.1" %_V_keep_V2, i2* noalias align 512 "unpacked"="11.2" %_V_strb_V3, i1* noalias align 512 "unpacked"="11.3" %_V_user_V4, i1* noalias align 512 "unpacked"="11.4" %_V_last_V5, i1* noalias align 512 "unpacked"="11.5" %_V_id_V6, i1* noalias align 512 "unpacked"="11.6" %_V_dest_V7) unnamed_addr #1 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a11i32([11 x i32]* align 512 %2, [11 x i32]* %1)
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_out(%"class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"* noalias, i16* noalias align 512 "unpacked"="1.0" %_V_data_V, i2* noalias align 512 "unpacked"="1.1" %_V_keep_V, i2* noalias align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %_V_user_V, i1* noalias align 512 "unpacked"="1.4" %_V_last_V, i1* noalias align 512 "unpacked"="1.5" %_V_id_V, i1* noalias align 512 "unpacked"="1.6" %_V_dest_V, [11 x i32]* noalias, [11 x i32]* noalias readonly align 512, %"class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"* noalias, i16* noalias align 512 "unpacked"="11.0" %_V_data_V1, i2* noalias align 512 "unpacked"="11.1" %_V_keep_V2, i2* noalias align 512 "unpacked"="11.2" %_V_strb_V3, i1* noalias align 512 "unpacked"="11.3" %_V_user_V4, i1* noalias align 512 "unpacked"="11.4" %_V_last_V5, i1* noalias align 512 "unpacked"="11.5" %_V_id_V6, i1* noalias align 512 "unpacked"="11.6" %_V_dest_V7) unnamed_addr #4 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a11i32([11 x i32]* %1, [11 x i32]* align 512 %2)
...
declare void @apatb_filt_hw(i16*, i2*, i2*, i1*, i1*, i1*, i1*, [11 x i32]*, i16*, i2*, i2*, i1*, i1*, i1*, i1*)

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_back(%"class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"* noalias, i16* noalias align 512 "unpacked"="1.0" %_V_data_V, i2* noalias align 512 "unpacked"="1.1" %_V_keep_V, i2* noalias align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %_V_user_V, i1* noalias align 512 "unpacked"="1.4" %_V_last_V, i1* noalias align 512 "unpacked"="1.5" %_V_id_V, i1* noalias align 512 "unpacked"="1.6" %_V_dest_V, [11 x i32]* noalias, [11 x i32]* noalias readonly align 512, %"class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"* noalias, i16* noalias align 512 "unpacked"="11.0" %_V_data_V1, i2* noalias align 512 "unpacked"="11.1" %_V_keep_V2, i2* noalias align 512 "unpacked"="11.2" %_V_strb_V3, i1* noalias align 512 "unpacked"="11.3" %_V_user_V4, i1* noalias align 512 "unpacked"="11.4" %_V_last_V5, i1* noalias align 512 "unpacked"="11.5" %_V_id_V6, i1* noalias align 512 "unpacked"="11.6" %_V_dest_V7) unnamed_addr #4 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"(%"class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"* %0, i16* align 512 %_V_data_V, i2* align 512 %_V_keep_V, i2* align 512 %_V_strb_V, i1* align 512 %_V_user_V, i1* align 512 %_V_last_V, i1* align 512 %_V_id_V, i1* align 512 %_V_dest_V)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"(%"class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"* %3, i16* align 512 %_V_data_V1, i2* align 512 %_V_keep_V2, i2* align 512 %_V_strb_V3, i1* align 512 %_V_user_V4, i1* align 512 %_V_last_V5, i1* align 512 %_V_id_V6, i1* align 512 %_V_dest_V7)
  ret void
...
define void @filt_hw_stub_wrapper(i16*, i2*, i2*, i1*, i1*, i1*, i1*, [11 x i32]*, i16*, i2*, i2*, i1*, i1*, i1*, i1*) #7 {
entry:
  ...
  call void @copy_out(%"class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"* %15, i16* %0, i2* %1, i2* %2, i1* %3, i1* %4, i1* %5, i1* %6, [11 x i32]* null, [11 x i32]* %7, %"class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"* %16, i16* %8, i2* %9, i2* %10, i1* %11, i1* %12, i1* %13, i1* %14)
  %17 = bitcast [11 x i32]* %7 to i32*
  call void @filt_hw_stub(%"class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"* %15, i32* %17, %"class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"* %16)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"* %15, i16* %0, i2* %1, i2* %2, i1* %3, i1* %4, i1* %5, i1* %6, [11 x i32]* null, [11 x i32]* %7, %"class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"* %16, i16* %8, i2* %9, i2* %10, i1* %11, i1* %12, i1* %13, i1* %14)
  ret void
}

declare void @filt_hw_stub(%"class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"*, i32*, %"class.hls::stream<hls::axis<ap_int<16>, 1, 1, 1, '8', false>, 0>"*)
