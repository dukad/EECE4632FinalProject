...
define void @apatb_filt_ir(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1, '8', false>, 0>"* noalias nonnull dereferenceable(12) %y, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="11" "maxi" %c, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1, '8', false>, 0>"* noalias nonnull dereferenceable(12) %x) local_unnamed_addr #0 {
entry:
  ...
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1, '8', false>, 0>"* nonnull %y, i32* nonnull align 512 %y_copy.data, i4* nonnull align 512 %y_copy.keep, i4* nonnull align 512 %y_copy.strb, i1* nonnull align 512 %y_copy.user, i1* nonnull align 512 %y_copy.last, i1* nonnull align 512 %y_copy.id, i1* nonnull align 512 %y_copy.dest, [11 x i32]* nonnull %0, [11 x i32]* nonnull align 512 %c_copy, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1, '8', false>, 0>"* nonnull %x, i32* nonnull align 512 %x_copy.data, i4* nonnull align 512 %x_copy.keep, i4* nonnull align 512 %x_copy.strb, i1* nonnull align 512 %x_copy.user, i1* nonnull align 512 %x_copy.last, i1* nonnull align 512 %x_copy.id, i1* nonnull align 512 %x_copy.dest)
  call void @apatb_filt_hw(i32* %y_copy.data, i4* %y_copy.keep, i4* %y_copy.strb, i1* %y_copy.user, i1* %y_copy.last, i1* %y_copy.id, i1* %y_copy.dest, [11 x i32]* %c_copy, i32* %x_copy.data, i4* %x_copy.keep, i4* %x_copy.strb, i1* %x_copy.user, i1* %x_copy.last, i1* %x_copy.id, i1* %x_copy.dest)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1, '8', false>, 0>"* %y, i32* %y_copy.data, i4* %y_copy.keep, i4* %y_copy.strb, i1* %y_copy.user, i1* %y_copy.last, i1* %y_copy.id, i1* %y_copy.dest, [11 x i32]* %0, [11 x i32]* %c_copy, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1, '8', false>, 0>"* %x, i32* %x_copy.data, i4* %x_copy.keep, i4* %x_copy.strb, i1* %x_copy.user, i1* %x_copy.last, i1* %x_copy.id, i1* %x_copy.dest)
  ret void
}

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1, '8', false>, 0>"* noalias, i32* noalias align 512 "unpacked"="1.0" %_V_data_V, i4* noalias align 512 "unpacked"="1.1" %_V_keep_V, i4* noalias align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %_V_user_V, i1* noalias align 512 "unpacked"="1.4" %_V_last_V, i1* noalias align 512 "unpacked"="1.5" %_V_id_V, i1* noalias align 512 "unpacked"="1.6" %_V_dest_V, [11 x i32]* noalias readonly, [11 x i32]* noalias align 512, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1, '8', false>, 0>"* noalias, i32* noalias align 512 "unpacked"="11.0" %_V_data_V1, i4* noalias align 512 "unpacked"="11.1" %_V_keep_V2, i4* noalias align 512 "unpacked"="11.2" %_V_strb_V3, i1* noalias align 512 "unpacked"="11.3" %_V_user_V4, i1* noalias align 512 "unpacked"="11.4" %_V_last_V5, i1* noalias align 512 "unpacked"="11.5" %_V_id_V6, i1* noalias align 512 "unpacked"="11.6" %_V_dest_V7) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_out(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1, '8', false>, 0>"* noalias, i32* noalias align 512 "unpacked"="1.0" %_V_data_V, i4* noalias align 512 "unpacked"="1.1" %_V_keep_V, i4* noalias align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %_V_user_V, i1* noalias align 512 "unpacked"="1.4" %_V_last_V, i1* noalias align 512 "unpacked"="1.5" %_V_id_V, i1* noalias align 512 "unpacked"="1.6" %_V_dest_V, [11 x i32]* noalias, [11 x i32]* noalias readonly align 512, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1, '8', false>, 0>"* noalias, i32* noalias align 512 "unpacked"="11.0" %_V_data_V1, i4* noalias align 512 "unpacked"="11.1" %_V_keep_V2, i4* noalias align 512 "unpacked"="11.2" %_V_strb_V3, i1* noalias align 512 "unpacked"="11.3" %_V_user_V4, i1* noalias align 512 "unpacked"="11.4" %_V_last_V5, i1* noalias align 512 "unpacked"="11.5" %_V_id_V6, i1* noalias align 512 "unpacked"="11.6" %_V_dest_V7) unnamed_addr #4 {
entry:
...
declare void @apatb_filt_hw(i32*, i4*, i4*, i1*, i1*, i1*, i1*, [11 x i32]*, i32*, i4*, i4*, i1*, i1*, i1*, i1*)

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_back(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1, '8', false>, 0>"* noalias, i32* noalias align 512 "unpacked"="1.0" %_V_data_V, i4* noalias align 512 "unpacked"="1.1" %_V_keep_V, i4* noalias align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %_V_user_V, i1* noalias align 512 "unpacked"="1.4" %_V_last_V, i1* noalias align 512 "unpacked"="1.5" %_V_id_V, i1* noalias align 512 "unpacked"="1.6" %_V_dest_V, [11 x i32]* noalias, [11 x i32]* noalias readonly align 512, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1, '8', false>, 0>"* noalias, i32* noalias align 512 "unpacked"="11.0" %_V_data_V1, i4* noalias align 512 "unpacked"="11.1" %_V_keep_V2, i4* noalias align 512 "unpacked"="11.2" %_V_strb_V3, i1* noalias align 512 "unpacked"="11.3" %_V_user_V4, i1* noalias align 512 "unpacked"="11.4" %_V_last_V5, i1* noalias align 512 "unpacked"="11.5" %_V_id_V6, i1* noalias align 512 "unpacked"="11.6" %_V_dest_V7) unnamed_addr #4 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1, '8', false>, 0>"(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1, '8', false>, 0>"* %0, i32* align 512 %_V_data_V, i4* align 512 %_V_keep_V, i4* align 512 %_V_strb_V, i1* align 512 %_V_user_V, i1* align 512 %_V_last_V, i1* align 512 %_V_id_V, i1* align 512 %_V_dest_V)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1, '8', false>, 0>"(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1, '8', false>, 0>"* %3, i32* align 512 %_V_data_V1, i4* align 512 %_V_keep_V2, i4* align 512 %_V_strb_V3, i1* align 512 %_V_user_V4, i1* align 512 %_V_last_V5, i1* align 512 %_V_id_V6, i1* align 512 %_V_dest_V7)
  ret void
...
define void @filt_hw_stub_wrapper(i32*, i4*, i4*, i1*, i1*, i1*, i1*, [11 x i32]*, i32*, i4*, i4*, i1*, i1*, i1*, i1*) #7 {
entry:
  ...
  call void @copy_out(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1, '8', false>, 0>"* %15, i32* %0, i4* %1, i4* %2, i1* %3, i1* %4, i1* %5, i1* %6, [11 x i32]* null, [11 x i32]* %7, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1, '8', false>, 0>"* %16, i32* %8, i4* %9, i4* %10, i1* %11, i1* %12, i1* %13, i1* %14)
  ...
  call void @copy_in(%"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1, '8', false>, 0>"* %15, i32* %0, i4* %1, i4* %2, i1* %3, i1* %4, i1* %5, i1* %6, [11 x i32]* null, [11 x i32]* %7, %"class.hls::stream<hls::axis<ap_int<32>, 1, 1, 1, '8', false>, 0>"* %16, i32* %8, i4* %9, i4* %10, i1* %11, i1* %12, i1* %13, i1* %14)
  ret void
}
