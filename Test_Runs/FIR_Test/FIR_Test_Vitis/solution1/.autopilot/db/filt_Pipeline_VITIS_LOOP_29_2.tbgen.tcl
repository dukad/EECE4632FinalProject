...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "c","offset": { "type": "dynamic","port_name": "c","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "phi_ln29", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ phi_ln29 sc_in sc_lv 1 signal 2 } 
	{ c sc_in sc_lv 64 signal 3 } 
	{ tmp_data sc_in sc_lv 32 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "phi_ln29", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "phi_ln29", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	phi_ln29 { ap_none {  { phi_ln29 in_data 0 1 } } }
