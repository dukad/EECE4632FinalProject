...
set solution_dir "C:/Users/a01me/Documents/GitHub/College/EECE4632FinalProject/Test_Runs/FIR_Test/FIR_Test_Vitis/solution1"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "C:/Users/a01me/Documents/GitHub/College/EECE4632FinalProject/Test_Runs/FIR_Test/FIR_Test_Vitis/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {filt_mul_16s_32s_32_2_1
filt_mul_32s_16s_32_2_1
filt_flow_control_loop_pipe_sequential_init
filt_gmem_m_axi
filt_control_s_axi
filt_regslice_both
filt_regslice_both
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 c_1 W 0x0 "Data signal of c" {{0 32 c W 0 "Bit 31 to 0 of c"}}} {0x14 c_2 W 0x0 "Data signal of c" {{0 32 c W 0 "Bit 63 to 32 of c"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_gmem y x"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
