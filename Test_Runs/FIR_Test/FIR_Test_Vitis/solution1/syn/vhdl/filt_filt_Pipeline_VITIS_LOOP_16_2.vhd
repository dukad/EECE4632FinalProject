...
entity filt_filt_Pipeline_VITIS_LOOP_16_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of filt_filt_Pipeline_VITIS_LOOP_16_2 is 
...
attribute shreg_extract : string;
    ...
    signal i_1_reg_117 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal i_fu_48 : STD_LOGIC_VECTOR (6 downto 0) := "0000000";
    signal add_ln16_fu_84_p2 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    add_ln16_fu_84_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv7_1));
    ...
    icmp_ln16_fu_78_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv7_63) else "0";
    ...
    m_axi_gmem_WDATA <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_1_reg_117),32));
