...
#
# Generated by export_simulation on Tue Apr 16 21:51:37 -0400 2024
#
################################################################################
...
'-reset_run' switch to the './guitar_effects_design.sh' script.

./guitar_effects_design.sh -reset_run
...
./guitar_effects_design.sh -noclean_files

For more information on the script, please type './guitar_effects_design.sh -help'.
