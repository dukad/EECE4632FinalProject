...
ISEStep( "vivado",
         "-log guitar_effects_design_axi_bram_ctrl_0_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source guitar_effects_design_axi_bram_ctrl_0_bram_0.tcl" );
