set moduleName equalizer_Pipeline_VITIS_LOOP_53_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {equalizer_Pipeline_VITIS_LOOP_53_1}
...
set C_modelArgList {
	...
	{ coef_scale int 32 regular  }
	{ coefs int 64 regular  }
	{ coefs_2 int 32 regular {array 99 { 0 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "coefs","offset": { "type": "dynamic","port_name": "coefs","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "coef_scale", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "coefs", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "coefs_2", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ input_r_TUSER sc_in sc_lv 1 signal 4 } 
	{ input_r_TLAST sc_in sc_lv 1 signal 5 } 
	{ input_r_TID sc_in sc_lv 1 signal 6 } 
	{ input_r_TDEST sc_in sc_lv 1 signal 7 } 
	{ coef_scale sc_in sc_lv 32 signal 8 } 
	{ coefs sc_in sc_lv 64 signal 9 } 
	{ coefs_2_address0 sc_out sc_lv 7 signal 10 } 
	{ coefs_2_ce0 sc_out sc_logic 1 signal 10 } 
	{ coefs_2_we0 sc_out sc_logic 1 signal 10 } 
	{ coefs_2_d0 sc_out sc_lv 32 signal 10 } 
	{ coefs_2_address1 sc_out sc_lv 7 signal 10 } 
	{ coefs_2_ce1 sc_out sc_logic 1 signal 10 } 
	{ coefs_2_q1 sc_in sc_lv 32 signal 10 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "coef_scale", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "coef_scale", "role": "default" }} , 
 	{ "name": "coefs", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "coefs", "role": "default" }} , 
 	{ "name": "coefs_2_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "coefs_2", "role": "address0" }} , 
 	{ "name": "coefs_2_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "coefs_2", "role": "ce0" }} , 
 	{ "name": "coefs_2_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "coefs_2", "role": "we0" }} , 
 	{ "name": "coefs_2_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "coefs_2", "role": "d0" }} , 
 	{ "name": "coefs_2_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "coefs_2", "role": "address1" }} , 
 	{ "name": "coefs_2_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "coefs_2", "role": "ce1" }} , 
 	{ "name": "coefs_2_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "coefs_2", "role": "q1" }} , 
...
set Spec2ImplPortList { 
	...
	coef_scale { ap_none {  { coef_scale in_data 0 32 } } }
	coefs { ap_none {  { coefs in_data 0 64 } } }
	coefs_2 { ap_memory {  { coefs_2_address0 mem_address 1 7 }  { coefs_2_ce0 mem_ce 1 1 }  { coefs_2_we0 mem_we 1 1 }  { coefs_2_d0 mem_din 1 32 }  { coefs_2_address1 MemPortADDR2 1 7 }  { coefs_2_ce1 MemPortCE2 1 1 }  { coefs_2_q1 MemPortDOUT2 0 32 } } }
}
