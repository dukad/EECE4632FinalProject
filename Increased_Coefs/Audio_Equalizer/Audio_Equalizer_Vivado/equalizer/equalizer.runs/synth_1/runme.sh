...
HD_PWD='C:/EECE4632FinalProject/Increased_Coefs/Audio_Equalizer/Audio_Equalizer_Vivado/equalizer/equalizer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log equalizer_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source equalizer_wrapper.tcl
