...
set id 1
set name equalizer_mac_muladd_16s_16s_32ns_32_4_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { signal_shift_reg_address0 { O 7 vector } signal_shift_reg_ce0 { O 1 bit } signal_shift_reg_we0 { O 1 bit } signal_shift_reg_d0 { O 16 vector } signal_shift_reg_address1 { O 7 vector } signal_shift_reg_ce1 { O 1 bit } signal_shift_reg_q1 { I 16 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { accumulate_out { O 16 vector } accumulate_out_ap_vld { O 1 bit } } \
} "
}
