set moduleName equalizer_Pipeline_VITIS_LOOP_48_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {equalizer_Pipeline_VITIS_LOOP_48_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "coefs","offset": { "type": "dynamic","port_name": "coefs","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "coef_scale", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ input_r_TDATA sc_in sc_lv 16 signal 1 } 
	{ input_r_TREADY sc_out sc_logic 1 inacc 7 } 
	{ input_r_TKEEP sc_in sc_lv 2 signal 2 } 
	{ input_r_TSTRB sc_in sc_lv 2 signal 3 } 
	...
	{ coef_scale sc_in sc_lv 16 signal 8 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "coef_scale", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "coef_scale", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	input_r_V_data_V { axis {  { input_r_TVALID in_vld 0 1 }  { input_r_TDATA in_data 0 16 } } }
	...
	coef_scale { ap_none {  { coef_scale in_data 0 16 } } }
