...
typedef int acc_t;
# 26 "./equalizer.h"
__attribute__((sdx_kernel("equalizer", 0))) void equalizer(hls::stream<AXI_VAL>& output, coef_t coefs[99], hls::stream<AXI_VAL>& input);
# 2 "equalizer.cpp" 2

__attribute__((sdx_kernel("equalizer", 0))) void equalizer(hls::stream<AXI_VAL>& output, coef_t coefs[99], hls::stream<AXI_VAL>& input) {
#line 17 "C:/Users/a01me/Documents/GitHub/College/EECE4632FinalProject/Increased_Coefs/Audio_Equalizer/Audio_Equalizer_Vitis/equalizer/solution18/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=equalizer
# 3 "equalizer.cpp"

#line 6 "C:/Users/a01me/Documents/GitHub/College/EECE4632FinalProject/Increased_Coefs/Audio_Equalizer/Audio_Equalizer_Vitis/equalizer/solution18/directives.tcl"
#pragma HLSDIRECTIVE TOP name=equalizer
# 3 "equalizer.cpp"
...
#pragma HLS PIPELINE
 coefs[i] = 0;
     ...
     for (j = 0; j < 3; j++){
      ...
      VITIS_LOOP_57_1: for (i = 0; i < 99; i++){
#pragma HLS PIPELINE
 input.read(tmp);
