set moduleName equalizer_Pipeline_VITIS_LOOP_58_11
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {equalizer_Pipeline_VITIS_LOOP_58_11}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "coefs","offset": { "type": "dynamic","port_name": "coefs","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "tmp_data_V_9", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ tmp_data_V_9 sc_in sc_lv 32 signal 8 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_data_V_9", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "tmp_data_V_9", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	tmp_data_V_9 { ap_none {  { tmp_data_V_9 in_data 0 32 } } }
