...
architecture behav of equalizer is 
    ...
    "equalizer_equalizer,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=6.200000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.526000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=1,HLS_SYN_DSP=0,HLS_SYN_FF=2373,HLS_SYN_LUT=3071,HLS_VERSION=2022_1}";
    ...
    signal state_1_reg_692 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_last_V_reg_725 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_last_V_1_reg_375 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal coefs_read_reg_655 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_CS_fsm_state1 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state1 : signal is "none";
    signal gmem_addr_reg_668 : STD_LOGIC_VECTOR (63 downto 0);
    signal state_1_load_fu_482_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_data_V_reg_696 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_keep_V_reg_704 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_strb_V_reg_711 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_user_V_reg_718 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_fu_430_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_id_V_reg_731 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_dest_V_reg_738 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln35_fu_508_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln35_reg_748 : STD_LOGIC_VECTOR (0 downto 0);
    signal gmem_addr_read_reg_753 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_514_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal mul_ln88_reg_758 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state16 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state16 : signal is "none";
    signal accumulate_fu_521_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal accumulate_reg_763 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln54_fu_562_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal add_ln54_reg_773 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_CS_fsm_state20 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state20 : signal is "none";
    signal icmp_ln71_fu_568_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln71_reg_788 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal grp_equalizer_Pipeline_Shift_Accumulate_Loop_fu_386_grp_fu_514_p_din0 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_equalizer_Pipeline_Shift_Accumulate_Loop_fu_386_grp_fu_514_p_din1 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_equalizer_Pipeline_Shift_Accumulate_Loop_fu_386_grp_fu_514_p_ce : STD_LOGIC;
    ...
    signal grp_equalizer_Pipeline_VITIS_LOOP_57_1_fu_403_grp_fu_514_p_din0 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_equalizer_Pipeline_VITIS_LOOP_57_1_fu_403_grp_fu_514_p_din1 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_equalizer_Pipeline_VITIS_LOOP_57_1_fu_403_grp_fu_514_p_ce : STD_LOGIC;
    ...
    signal ap_predicate_op123_write_state18 : BOOLEAN;
    signal ap_block_state18 : BOOLEAN;
    signal ap_block_state18_io : BOOLEAN;
    signal ap_CS_fsm_state24 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state24 : signal is "none";
    signal ap_phi_mux_tmp_last_V_1_phi_fu_378_p4 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_data_V_2_reg_365 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal select_ln16_fu_591_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal select_ln16_1_fu_574_p3 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    component equalizer_mul_32s_32s_32_5_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    mul_32s_32s_32_5_1_U19 : component equalizer_mul_32s_32s_32_5_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((read_coefs_load_load_fu_505_p1 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2) and (state_1_load_fu_482_p1 = ap_const_lv32_10) and (input_r_TVALID_int_regslice = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (state_1_load_fu_482_p1 = ap_const_lv32_100) and (input_r_TVALID_int_regslice = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((icmp_ln54_fu_556_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state20))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((grp_equalizer_Pipeline_Coef_Clear_Loop_fu_396_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state19))) then 
                coef_scale_reg_343 <= tmp_data_V_reg_696;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state22) and (input_r_TVALID_int_regslice = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_phi_mux_tmp_last_V_1_phi_fu_378_p4 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state24))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then 
                state_fu_160(4) <= '0';
                state_fu_160(8) <= '0';
            elsif ((not(((ap_const_boolean_1 = ap_block_state18_io) or ((output_r_TREADY_int_regslice = ap_const_logic_0) and (ap_predicate_op123_write_state18 = ap_const_boolean_1)) or ((output_r_TREADY_int_regslice = ap_const_logic_0) and (state_1_reg_692 = ap_const_lv32_100)))) and (ap_const_logic_1 = ap_CS_fsm_state18) and (tmp_last_V_reg_725 = ap_const_lv1_0) and (state_1_reg_692 = ap_const_lv32_100))) then 
                state_fu_160(4) <= '0';
                state_fu_160(8) <= '1';
            elsif (((ap_phi_mux_tmp_last_V_1_phi_fu_378_p4 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state24))) then 
                                state_fu_160(4) <= select_ln16_1_fu_574_p3(4);                state_fu_160(8) <= select_ln16_1_fu_574_p3(8);
            elsif (((ap_const_logic_1 = ap_CS_fsm_state25) and (tmp_last_V_reg_725 = ap_const_lv1_0))) then 
                                state_fu_160(4) <= select_ln16_fu_591_p3(4);                state_fu_160(8) <= select_ln16_fu_591_p3(8);
            end if; 
        end if;
    end process;

    tmp_data_V_2_reg_365_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln54_fu_556_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state20))) then 
                tmp_data_V_2_reg_365 <= coef_scale_reg_343;
            elsif (((read_coefs_load_load_fu_505_p1 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2) and (state_1_load_fu_482_p1 = ap_const_lv32_10) and (input_r_TVALID_int_regslice = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_const_boolean_1 = ap_block_state18_io) or ((output_r_TREADY_int_regslice = ap_const_logic_0) and (ap_predicate_op123_write_state18 = ap_const_boolean_1)) or ((output_r_TREADY_int_regslice = ap_const_logic_0) and (state_1_reg_692 = ap_const_lv32_100)))) and (ap_const_logic_1 = ap_CS_fsm_state18) and (tmp_last_V_reg_725 = ap_const_lv1_1) and (state_1_reg_692 = ap_const_lv32_100))) then 
                tmp_data_V_5_reg_316 <= accumulate_reg_763;
            elsif ((((ap_phi_mux_tmp_last_V_1_phi_fu_378_p4 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state24)) or (not((state_1_load_fu_482_p1 = ap_const_lv32_100)) and not((state_1_load_fu_482_p1 = ap_const_lv32_10)) and not((state_1_load_fu_482_p1 = ap_const_lv32_0)) and (ap_const_logic_1 = ap_CS_fsm_state2) and (grp_fu_430_p1 = ap_const_lv1_1) and (input_r_TVALID_int_regslice = ap_const_logic_1)) or ((ap_const_logic_1 = ap_CS_fsm_state25) and (tmp_last_V_reg_725 = ap_const_lv1_1)))) then 
    ...
    tmp_last_V_1_reg_375_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln54_fu_556_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state20))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (state_1_load_fu_482_p1 = ap_const_lv32_0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                    state_1_reg_692(4) <= state_fu_160(4);    state_1_reg_692(8) <= state_fu_160(8);
    ...
    state_1_reg_692(3 downto 0) <= "0000";
    state_1_reg_692(7 downto 5) <= "000";
    state_1_reg_692(31 downto 9) <= "00000000000000000000000";
    state_fu_160(3 downto 0) <= "0000";
    state_fu_160(7 downto 5) <= "000";
    state_fu_160(31 downto 9) <= "00000000000000000000000";

    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state4, ap_CS_fsm_state11, ap_CS_fsm_state17, ap_CS_fsm_state18, state_1_reg_692, tmp_last_V_reg_725, tmp_last_V_1_reg_375, ap_CS_fsm_state26, ap_CS_fsm_state2, ap_CS_fsm_state22, state_1_load_fu_482_p1, ap_CS_fsm_state20, grp_equalizer_Pipeline_Shift_Accumulate_Loop_fu_386_ap_done, grp_equalizer_Pipeline_Coef_Clear_Loop_fu_396_ap_done, grp_equalizer_Pipeline_VITIS_LOOP_57_1_fu_403_ap_done, gmem_ARREADY, gmem_RVALID, ap_predicate_op123_write_state18, ap_block_state18_io, ap_CS_fsm_state19, read_coefs_load_load_fu_505_p1, icmp_ln54_fu_556_p2, ap_CS_fsm_state3, ap_CS_fsm_state21, regslice_both_output_r_V_data_V_U_apdone_blk, output_r_TREADY_int_regslice, input_r_TVALID_int_regslice)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                ap_NS_fsm <= ap_ST_fsm_state2;
            when ap_ST_fsm_state2 => 
                if ((not((state_1_load_fu_482_p1 = ap_const_lv32_100)) and not((state_1_load_fu_482_p1 = ap_const_lv32_10)) and not((state_1_load_fu_482_p1 = ap_const_lv32_0)) and (ap_const_logic_1 = ap_CS_fsm_state2) and (input_r_TVALID_int_regslice = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state18;
                elsif (((read_coefs_load_load_fu_505_p1 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2) and (state_1_load_fu_482_p1 = ap_const_lv32_10) and (input_r_TVALID_int_regslice = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state23;
                elsif (((read_coefs_load_load_fu_505_p1 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2) and (state_1_load_fu_482_p1 = ap_const_lv32_10) and (input_r_TVALID_int_regslice = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state19;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (state_1_load_fu_482_p1 = ap_const_lv32_0) and (input_r_TVALID_int_regslice = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state25;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (state_1_load_fu_482_p1 = ap_const_lv32_100) and (input_r_TVALID_int_regslice = ap_const_logic_1))) then
            ...
            when ap_ST_fsm_state18 => 
                if ((not(((ap_const_boolean_1 = ap_block_state18_io) or ((output_r_TREADY_int_regslice = ap_const_logic_0) and (ap_predicate_op123_write_state18 = ap_const_boolean_1)) or ((output_r_TREADY_int_regslice = ap_const_logic_0) and (state_1_reg_692 = ap_const_lv32_100)))) and (ap_const_logic_1 = ap_CS_fsm_state18) and (((tmp_last_V_1_reg_375 = ap_const_lv1_0) and (state_1_reg_692 = ap_const_lv32_10)) or (not((state_1_reg_692 = ap_const_lv32_10)) and (tmp_last_V_reg_725 = ap_const_lv1_0))))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                elsif ((not(((ap_const_boolean_1 = ap_block_state18_io) or ((output_r_TREADY_int_regslice = ap_const_logic_0) and (ap_predicate_op123_write_state18 = ap_const_boolean_1)) or ((output_r_TREADY_int_regslice = ap_const_logic_0) and (state_1_reg_692 = ap_const_lv32_100)))) and (ap_const_logic_1 = ap_CS_fsm_state18) and (((tmp_last_V_1_reg_375 = ap_const_lv1_1) and (state_1_reg_692 = ap_const_lv32_10)) or (not((state_1_reg_692 = ap_const_lv32_10)) and (tmp_last_V_reg_725 = ap_const_lv1_1))))) then
            ...
            when ap_ST_fsm_state21 => 
                if (((grp_equalizer_Pipeline_VITIS_LOOP_57_1_fu_403_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state21))) then
    ...
    accumulate_fu_521_p2 <= std_logic_vector(unsigned(mul_ln88_reg_758) + unsigned(grp_equalizer_Pipeline_Shift_Accumulate_Loop_fu_386_accumulate_out));
    add_ln54_fu_562_p2 <= std_logic_vector(unsigned(j_reg_332) + unsigned(ap_const_lv2_1));
    ...
    ap_ST_fsm_state18_blk_assign_proc : process(state_1_reg_692, ap_predicate_op123_write_state18, ap_block_state18_io, output_r_TREADY_int_regslice)
    begin
        if (((ap_const_boolean_1 = ap_block_state18_io) or ((output_r_TREADY_int_regslice = ap_const_logic_0) and (ap_predicate_op123_write_state18 = ap_const_boolean_1)) or ((output_r_TREADY_int_regslice = ap_const_logic_0) and (state_1_reg_692 = ap_const_lv32_100)))) then 
    ...
    ap_ST_fsm_state19_blk_assign_proc : process(grp_equalizer_Pipeline_Coef_Clear_Loop_fu_396_ap_done)
    begin
    ...
    ap_ST_fsm_state21_blk_assign_proc : process(grp_equalizer_Pipeline_VITIS_LOOP_57_1_fu_403_ap_done)
    begin
    ...
    ap_block_state18_assign_proc : process(state_1_reg_692, ap_predicate_op123_write_state18, output_r_TREADY_int_regslice)
    begin
                ap_block_state18 <= (((output_r_TREADY_int_regslice = ap_const_logic_0) and (ap_predicate_op123_write_state18 = ap_const_boolean_1)) or ((output_r_TREADY_int_regslice = ap_const_logic_0) and (state_1_reg_692 = ap_const_lv32_100)));
    end process;


    ap_block_state18_io_assign_proc : process(state_1_reg_692, ap_predicate_op123_write_state18, output_r_TREADY_int_regslice)
    begin
                ap_block_state18_io <= (((output_r_TREADY_int_regslice = ap_const_logic_0) and (ap_predicate_op123_write_state18 = ap_const_boolean_1)) or ((output_r_TREADY_int_regslice = ap_const_logic_0) and (state_1_reg_692 = ap_const_lv32_100)));
    end process;
    ...
    ap_phi_mux_tmp_data_V_5_phi_fu_320_p8_assign_proc : process(ap_CS_fsm_state18, state_1_reg_692, tmp_last_V_reg_725, accumulate_reg_763, tmp_data_V_5_reg_316)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state18) and (tmp_last_V_reg_725 = ap_const_lv1_1) and (state_1_reg_692 = ap_const_lv32_100))) then 
    ...
    ap_phi_mux_tmp_dest_V_1_phi_fu_240_p8_assign_proc : process(ap_CS_fsm_state18, state_1_reg_692, tmp_last_V_reg_725, tmp_dest_V_reg_738, tmp_dest_V_1_reg_236)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state18) and (tmp_last_V_reg_725 = ap_const_lv1_1) and (state_1_reg_692 = ap_const_lv32_100))) then 
    ...
    ap_phi_mux_tmp_id_V_1_phi_fu_256_p8_assign_proc : process(ap_CS_fsm_state18, state_1_reg_692, tmp_last_V_reg_725, tmp_id_V_reg_731, tmp_id_V_1_reg_252)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state18) and (tmp_last_V_reg_725 = ap_const_lv1_1) and (state_1_reg_692 = ap_const_lv32_100))) then 
    ...
    ap_phi_mux_tmp_keep_V_1_phi_fu_304_p8_assign_proc : process(ap_CS_fsm_state18, state_1_reg_692, tmp_last_V_reg_725, tmp_keep_V_reg_704, tmp_keep_V_1_reg_300)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state18) and (tmp_last_V_reg_725 = ap_const_lv1_1) and (state_1_reg_692 = ap_const_lv32_100))) then 
    ...
    ap_phi_mux_tmp_last_V_1_phi_fu_378_p4 <= tmp_last_V_1_reg_375;

    ap_phi_mux_tmp_strb_V_1_phi_fu_288_p8_assign_proc : process(ap_CS_fsm_state18, state_1_reg_692, tmp_last_V_reg_725, tmp_strb_V_reg_711, tmp_strb_V_1_reg_284)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state18) and (tmp_last_V_reg_725 = ap_const_lv1_1) and (state_1_reg_692 = ap_const_lv32_100))) then 
    ...
    ap_phi_mux_tmp_user_V_1_phi_fu_272_p8_assign_proc : process(ap_CS_fsm_state18, state_1_reg_692, tmp_last_V_reg_725, tmp_user_V_reg_718, tmp_user_V_1_reg_268)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state18) and (tmp_last_V_reg_725 = ap_const_lv1_1) and (state_1_reg_692 = ap_const_lv32_100))) then 
    ...
    ap_predicate_op123_write_state18_assign_proc : process(state_1_reg_692, tmp_last_V_reg_725, tmp_last_V_1_reg_375)
    begin
                ap_predicate_op123_write_state18 <= (((tmp_last_V_1_reg_375 = ap_const_lv1_1) and (state_1_reg_692 = ap_const_lv32_10)) or (not((state_1_reg_692 = ap_const_lv32_10)) and (tmp_last_V_reg_725 = ap_const_lv1_1)));
    end process;
    ...
    gmem_ARADDR_assign_proc : process(ap_CS_fsm_state4, ap_CS_fsm_state2, gmem_addr_reg_668, state_1_load_fu_482_p1, ap_CS_fsm_state20, grp_equalizer_Pipeline_Shift_Accumulate_Loop_fu_386_m_axi_gmem_ARADDR, grp_equalizer_Pipeline_VITIS_LOOP_57_1_fu_403_m_axi_gmem_ARADDR, gmem_ARREADY, icmp_ln54_fu_556_p2, ap_CS_fsm_state3, ap_CS_fsm_state21)
    begin
        if (((gmem_ARREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
            gmem_ARADDR <= gmem_addr_reg_668;
        elsif (((ap_const_logic_1 = ap_CS_fsm_state21) or ((icmp_ln54_fu_556_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state20)))) then 
    ...
    gmem_ARLEN_assign_proc : process(ap_CS_fsm_state4, ap_CS_fsm_state2, state_1_load_fu_482_p1, ap_CS_fsm_state20, grp_equalizer_Pipeline_Shift_Accumulate_Loop_fu_386_m_axi_gmem_ARLEN, grp_equalizer_Pipeline_VITIS_LOOP_57_1_fu_403_m_axi_gmem_ARLEN, gmem_ARREADY, icmp_ln54_fu_556_p2, ap_CS_fsm_state3, ap_CS_fsm_state21)
    begin
        if (((gmem_ARREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    gmem_ARVALID_assign_proc : process(ap_CS_fsm_state4, ap_CS_fsm_state2, state_1_load_fu_482_p1, ap_CS_fsm_state20, grp_equalizer_Pipeline_Shift_Accumulate_Loop_fu_386_m_axi_gmem_ARVALID, grp_equalizer_Pipeline_VITIS_LOOP_57_1_fu_403_m_axi_gmem_ARVALID, gmem_ARREADY, icmp_ln54_fu_556_p2, ap_CS_fsm_state3, ap_CS_fsm_state21)
    begin
        if (((gmem_ARREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    gmem_AWADDR_assign_proc : process(ap_CS_fsm_state2, state_1_load_fu_482_p1, ap_CS_fsm_state20, grp_equalizer_Pipeline_Coef_Clear_Loop_fu_396_m_axi_gmem_AWADDR, grp_equalizer_Pipeline_VITIS_LOOP_57_1_fu_403_m_axi_gmem_AWADDR, ap_CS_fsm_state19, read_coefs_load_load_fu_505_p1, icmp_ln54_fu_556_p2, ap_CS_fsm_state21)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state21) or ((icmp_ln54_fu_556_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state20)))) then 
            gmem_AWADDR <= grp_equalizer_Pipeline_VITIS_LOOP_57_1_fu_403_m_axi_gmem_AWADDR;
        elsif (((ap_const_logic_1 = ap_CS_fsm_state19) or ((read_coefs_load_load_fu_505_p1 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2) and (state_1_load_fu_482_p1 = ap_const_lv32_10)))) then 
    ...
    gmem_AWLEN_assign_proc : process(ap_CS_fsm_state2, state_1_load_fu_482_p1, ap_CS_fsm_state20, grp_equalizer_Pipeline_Coef_Clear_Loop_fu_396_m_axi_gmem_AWLEN, grp_equalizer_Pipeline_VITIS_LOOP_57_1_fu_403_m_axi_gmem_AWLEN, ap_CS_fsm_state19, read_coefs_load_load_fu_505_p1, icmp_ln54_fu_556_p2, ap_CS_fsm_state21)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state21) or ((icmp_ln54_fu_556_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state20)))) then 
    ...
    gmem_AWVALID_assign_proc : process(ap_CS_fsm_state2, state_1_load_fu_482_p1, ap_CS_fsm_state20, grp_equalizer_Pipeline_Coef_Clear_Loop_fu_396_m_axi_gmem_AWVALID, grp_equalizer_Pipeline_VITIS_LOOP_57_1_fu_403_m_axi_gmem_AWVALID, ap_CS_fsm_state19, read_coefs_load_load_fu_505_p1, icmp_ln54_fu_556_p2, ap_CS_fsm_state21)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state21) or ((icmp_ln54_fu_556_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state20)))) then 
    ...
    gmem_BREADY_assign_proc : process(ap_CS_fsm_state2, state_1_load_fu_482_p1, ap_CS_fsm_state20, grp_equalizer_Pipeline_Coef_Clear_Loop_fu_396_m_axi_gmem_BREADY, grp_equalizer_Pipeline_VITIS_LOOP_57_1_fu_403_m_axi_gmem_BREADY, ap_CS_fsm_state19, read_coefs_load_load_fu_505_p1, icmp_ln54_fu_556_p2, ap_CS_fsm_state21)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state21) or ((icmp_ln54_fu_556_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state20)))) then 
    ...
    gmem_RREADY_assign_proc : process(ap_CS_fsm_state11, ap_CS_fsm_state2, state_1_load_fu_482_p1, ap_CS_fsm_state20, grp_equalizer_Pipeline_Shift_Accumulate_Loop_fu_386_m_axi_gmem_RREADY, grp_equalizer_Pipeline_VITIS_LOOP_57_1_fu_403_m_axi_gmem_RREADY, gmem_RVALID, icmp_ln54_fu_556_p2, ap_CS_fsm_state3, ap_CS_fsm_state21)
    begin
        if (((gmem_RVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state11))) then 
    ...
    gmem_WDATA_assign_proc : process(ap_CS_fsm_state2, state_1_load_fu_482_p1, ap_CS_fsm_state20, grp_equalizer_Pipeline_Coef_Clear_Loop_fu_396_m_axi_gmem_WDATA, grp_equalizer_Pipeline_VITIS_LOOP_57_1_fu_403_m_axi_gmem_WDATA, ap_CS_fsm_state19, read_coefs_load_load_fu_505_p1, icmp_ln54_fu_556_p2, ap_CS_fsm_state21)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state21) or ((icmp_ln54_fu_556_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state20)))) then 
    ...
    gmem_WSTRB_assign_proc : process(ap_CS_fsm_state2, state_1_load_fu_482_p1, ap_CS_fsm_state20, grp_equalizer_Pipeline_Coef_Clear_Loop_fu_396_m_axi_gmem_WSTRB, grp_equalizer_Pipeline_VITIS_LOOP_57_1_fu_403_m_axi_gmem_WSTRB, ap_CS_fsm_state19, read_coefs_load_load_fu_505_p1, icmp_ln54_fu_556_p2, ap_CS_fsm_state21)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state21) or ((icmp_ln54_fu_556_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state20)))) then 
    ...
    gmem_WVALID_assign_proc : process(ap_CS_fsm_state2, state_1_load_fu_482_p1, ap_CS_fsm_state20, grp_equalizer_Pipeline_Coef_Clear_Loop_fu_396_m_axi_gmem_WVALID, grp_equalizer_Pipeline_VITIS_LOOP_57_1_fu_403_m_axi_gmem_WVALID, ap_CS_fsm_state19, read_coefs_load_load_fu_505_p1, icmp_ln54_fu_556_p2, ap_CS_fsm_state21)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state21) or ((icmp_ln54_fu_556_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state20)))) then 
    ...
    grp_fu_514_ce_assign_proc : process(grp_equalizer_Pipeline_Shift_Accumulate_Loop_fu_386_grp_fu_514_p_ce, grp_equalizer_Pipeline_VITIS_LOOP_57_1_fu_403_grp_fu_514_p_ce, ap_CS_fsm_state3, ap_CS_fsm_state21)
    begin
    ...
    grp_fu_514_p0_assign_proc : process(gmem_addr_read_reg_753, grp_equalizer_Pipeline_Shift_Accumulate_Loop_fu_386_grp_fu_514_p_din0, grp_equalizer_Pipeline_VITIS_LOOP_57_1_fu_403_grp_fu_514_p_din0, ap_CS_fsm_state3, ap_CS_fsm_state21, ap_CS_fsm_state12)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    grp_fu_514_p1_assign_proc : process(tmp_data_V_reg_696, grp_equalizer_Pipeline_Shift_Accumulate_Loop_fu_386_grp_fu_514_p_din1, grp_equalizer_Pipeline_VITIS_LOOP_57_1_fu_403_grp_fu_514_p_din1, ap_CS_fsm_state3, ap_CS_fsm_state21, ap_CS_fsm_state12)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    icmp_ln54_fu_556_p2 <= "1" when (j_reg_332 = ap_const_lv2_3) else "0";
    icmp_ln71_fu_568_p2 <= "1" when (tmp_data_V_2_reg_365 = ap_const_lv32_ABBA) else "0";

    input_r_TDATA_blk_n_assign_proc : process(ap_CS_fsm_state2, ap_CS_fsm_state22, input_r_TVALID_int_regslice)
    begin
    ...
    input_r_TREADY_int_regslice_assign_proc : process(ap_CS_fsm_state2, ap_CS_fsm_state22, grp_equalizer_Pipeline_VITIS_LOOP_57_1_fu_403_input_r_TREADY, ap_CS_fsm_state21, input_r_TVALID_int_regslice)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_state22) and (input_r_TVALID_int_regslice = ap_const_logic_1)) or ((ap_const_logic_1 = ap_CS_fsm_state2) and (input_r_TVALID_int_regslice = ap_const_logic_1)))) then 
    ...
    output_r_TDATA_blk_n_assign_proc : process(ap_CS_fsm_state17, ap_CS_fsm_state18, state_1_reg_692, tmp_last_V_reg_725, tmp_last_V_1_reg_375, ap_CS_fsm_state26, output_r_TREADY_int_regslice)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state26) or (ap_const_logic_1 = ap_CS_fsm_state17) or ((ap_const_logic_1 = ap_CS_fsm_state18) and (((tmp_last_V_1_reg_375 = ap_const_lv1_1) and (state_1_reg_692 = ap_const_lv32_10)) or (not((state_1_reg_692 = ap_const_lv32_10)) and (tmp_last_V_reg_725 = ap_const_lv1_1)))) or ((ap_const_logic_1 = ap_CS_fsm_state18) and (state_1_reg_692 = ap_const_lv32_100)))) then 
    ...
    output_r_TDATA_int_regslice_assign_proc : process(ap_CS_fsm_state17, ap_CS_fsm_state18, state_1_reg_692, accumulate_fu_521_p2, ap_predicate_op123_write_state18, ap_phi_mux_tmp_data_V_5_phi_fu_320_p8, output_r_TREADY_int_regslice)
    begin
        if ((not((((output_r_TREADY_int_regslice = ap_const_logic_0) and (ap_predicate_op123_write_state18 = ap_const_boolean_1)) or ((output_r_TREADY_int_regslice = ap_const_logic_0) and (state_1_reg_692 = ap_const_lv32_100)))) and (ap_predicate_op123_write_state18 = ap_const_boolean_1) and (ap_const_logic_1 = ap_CS_fsm_state18))) then 
    ...
    output_r_TDEST_int_regslice_assign_proc : process(ap_CS_fsm_state17, ap_CS_fsm_state18, state_1_reg_692, tmp_dest_V_reg_738, ap_phi_mux_tmp_dest_V_1_phi_fu_240_p8, ap_predicate_op123_write_state18, output_r_TREADY_int_regslice)
    begin
        if ((not((((output_r_TREADY_int_regslice = ap_const_logic_0) and (ap_predicate_op123_write_state18 = ap_const_boolean_1)) or ((output_r_TREADY_int_regslice = ap_const_logic_0) and (state_1_reg_692 = ap_const_lv32_100)))) and (ap_predicate_op123_write_state18 = ap_const_boolean_1) and (ap_const_logic_1 = ap_CS_fsm_state18))) then 
    ...
    output_r_TID_int_regslice_assign_proc : process(ap_CS_fsm_state17, ap_CS_fsm_state18, state_1_reg_692, tmp_id_V_reg_731, ap_predicate_op123_write_state18, ap_phi_mux_tmp_id_V_1_phi_fu_256_p8, output_r_TREADY_int_regslice)
    begin
        if ((not((((output_r_TREADY_int_regslice = ap_const_logic_0) and (ap_predicate_op123_write_state18 = ap_const_boolean_1)) or ((output_r_TREADY_int_regslice = ap_const_logic_0) and (state_1_reg_692 = ap_const_lv32_100)))) and (ap_predicate_op123_write_state18 = ap_const_boolean_1) and (ap_const_logic_1 = ap_CS_fsm_state18))) then 
    ...
    output_r_TKEEP_int_regslice_assign_proc : process(ap_CS_fsm_state17, ap_CS_fsm_state18, state_1_reg_692, tmp_keep_V_reg_704, ap_predicate_op123_write_state18, ap_phi_mux_tmp_keep_V_1_phi_fu_304_p8, output_r_TREADY_int_regslice)
    begin
        if ((not((((output_r_TREADY_int_regslice = ap_const_logic_0) and (ap_predicate_op123_write_state18 = ap_const_boolean_1)) or ((output_r_TREADY_int_regslice = ap_const_logic_0) and (state_1_reg_692 = ap_const_lv32_100)))) and (ap_predicate_op123_write_state18 = ap_const_boolean_1) and (ap_const_logic_1 = ap_CS_fsm_state18))) then 
    ...
    output_r_TLAST_int_regslice_assign_proc : process(ap_CS_fsm_state17, ap_CS_fsm_state18, state_1_reg_692, tmp_last_V_reg_725, ap_predicate_op123_write_state18, output_r_TREADY_int_regslice)
    begin
        if ((not((((output_r_TREADY_int_regslice = ap_const_logic_0) and (ap_predicate_op123_write_state18 = ap_const_boolean_1)) or ((output_r_TREADY_int_regslice = ap_const_logic_0) and (state_1_reg_692 = ap_const_lv32_100)))) and (ap_predicate_op123_write_state18 = ap_const_boolean_1) and (ap_const_logic_1 = ap_CS_fsm_state18))) then 
    ...
    output_r_TSTRB_int_regslice_assign_proc : process(ap_CS_fsm_state17, ap_CS_fsm_state18, state_1_reg_692, tmp_strb_V_reg_711, ap_predicate_op123_write_state18, ap_phi_mux_tmp_strb_V_1_phi_fu_288_p8, output_r_TREADY_int_regslice)
    begin
        if ((not((((output_r_TREADY_int_regslice = ap_const_logic_0) and (ap_predicate_op123_write_state18 = ap_const_boolean_1)) or ((output_r_TREADY_int_regslice = ap_const_logic_0) and (state_1_reg_692 = ap_const_lv32_100)))) and (ap_predicate_op123_write_state18 = ap_const_boolean_1) and (ap_const_logic_1 = ap_CS_fsm_state18))) then 
    ...
    output_r_TUSER_int_regslice_assign_proc : process(ap_CS_fsm_state17, ap_CS_fsm_state18, state_1_reg_692, tmp_user_V_reg_718, ap_predicate_op123_write_state18, ap_phi_mux_tmp_user_V_1_phi_fu_272_p8, output_r_TREADY_int_regslice)
    begin
        if ((not((((output_r_TREADY_int_regslice = ap_const_logic_0) and (ap_predicate_op123_write_state18 = ap_const_boolean_1)) or ((output_r_TREADY_int_regslice = ap_const_logic_0) and (state_1_reg_692 = ap_const_lv32_100)))) and (ap_predicate_op123_write_state18 = ap_const_boolean_1) and (ap_const_logic_1 = ap_CS_fsm_state18))) then 
    ...
    output_r_TVALID_int_regslice_assign_proc : process(ap_CS_fsm_state17, ap_CS_fsm_state18, state_1_reg_692, ap_predicate_op123_write_state18, ap_block_state18_io, output_r_TREADY_int_regslice)
    begin
        if (((not(((ap_const_boolean_1 = ap_block_state18_io) or ((output_r_TREADY_int_regslice = ap_const_logic_0) and (ap_predicate_op123_write_state18 = ap_const_boolean_1)) or ((output_r_TREADY_int_regslice = ap_const_logic_0) and (state_1_reg_692 = ap_const_lv32_100)))) and (ap_predicate_op123_write_state18 = ap_const_boolean_1) and (ap_const_logic_1 = ap_CS_fsm_state18)) or ((output_r_TREADY_int_regslice = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state17)))) then 
    ...
    select_ln16_1_fu_574_p3 <= 
        ap_const_lv32_100 when (icmp_ln71_reg_788(0) = '1') else 
        ap_const_lv32_10;
    select_ln16_fu_591_p3 <= 
        ap_const_lv32_10 when (icmp_ln35_reg_748(0) = '1') else 
        ap_const_lv32_0;
    ...
    signal_shift_reg_d0_assign_proc : process(ap_CS_fsm_state4, tmp_data_V_reg_696, grp_equalizer_Pipeline_Shift_Accumulate_Loop_fu_386_signal_shift_reg_d0, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
