...
extern "C" void equalizer(short*, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, int, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
extern "C" void apatb_equalizer_hw(volatile void * __xlx_apatb_param_output_V_data_V, volatile void * __xlx_apatb_param_output_V_keep_V, volatile void * __xlx_apatb_param_output_V_strb_V, volatile void * __xlx_apatb_param_output_V_user_V, volatile void * __xlx_apatb_param_output_V_last_V, volatile void * __xlx_apatb_param_output_V_id_V, volatile void * __xlx_apatb_param_output_V_dest_V, volatile void * __xlx_apatb_param_coefs, volatile void * __xlx_apatb_param_input_V_data_V, volatile void * __xlx_apatb_param_input_V_keep_V, volatile void * __xlx_apatb_param_input_V_strb_V, volatile void * __xlx_apatb_param_input_V_user_V, volatile void * __xlx_apatb_param_input_V_last_V, volatile void * __xlx_apatb_param_input_V_id_V, volatile void * __xlx_apatb_param_input_V_dest_V) {
  ...
  vector<sc_bv<16> >__xlx_coefs__tmp_vec;
  for (int j = 0, e = 99; j != e; ++j) {
    sc_bv<16> _xlx_tmp_sc;
    _xlx_tmp_sc.range(7, 0) = ((char*)__xlx_apatb_param_coefs)[j*2+0];
    _xlx_tmp_sc.range(15, 8) = ((char*)__xlx_apatb_param_coefs)[j*2+1];
    __xlx_coefs__tmp_vec.push_back(_xlx_tmp_sc);
  }
  int __xlx_size_param_coefs = 99;
  int __xlx_offset_param_coefs = 0;
  int __xlx_offset_byte_param_coefs = 0*2;
  short* __xlx_coefs__input_buffer= new short[__xlx_coefs__tmp_vec.size()];
  for (int i = 0; i < __xlx_coefs__tmp_vec.size(); ++i) {
    __xlx_coefs__input_buffer[i] = __xlx_coefs__tmp_vec[i].range(15, 0).to_uint64();
  }
...
auto* sinput_V_dest_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_input_V_dest_V);
  // DUT call
  equalizer(__xlx_coefs__input_buffer, soutput_V_data_V->data<short>(), soutput_V_keep_V->data<char>(), soutput_V_strb_V->data<char>(), soutput_V_user_V->data<char>(), soutput_V_last_V->data<char>(), soutput_V_id_V->data<char>(), soutput_V_dest_V->data<char>(), __xlx_offset_byte_param_coefs, sinput_V_data_V->data<short>(), sinput_V_keep_V->data<char>(), sinput_V_strb_V->data<char>(), sinput_V_user_V->data<char>(), sinput_V_last_V->data<char>(), sinput_V_id_V->data<char>(), sinput_V_dest_V->data<char>());
// print __xlx_apatb_param_coefs
  sc_bv<16>*__xlx_coefs_output_buffer = new sc_bv<16>[__xlx_size_param_coefs];
  for (int i = 0; i < __xlx_size_param_coefs; ++i) {
    __xlx_coefs_output_buffer[i] = __xlx_coefs__input_buffer[i+__xlx_offset_param_coefs];
  }
  for (int i = 0; i < __xlx_size_param_coefs; ++i) {
    ((char*)__xlx_apatb_param_coefs)[i*2+0] = __xlx_coefs_output_buffer[i].range(7, 0).to_uint();
    ((char*)__xlx_apatb_param_coefs)[i*2+1] = __xlx_coefs_output_buffer[i].range(15, 8).to_uint();
  }
