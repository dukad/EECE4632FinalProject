...
architecture behav of equalizer is 
    ...
    signal j_1_fu_553_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal j_1_reg_738 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal state_3283_reg_377 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    state_3283_reg_377_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_phi_mux_tmp_last_V_1_phi_fu_352_p6 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state21))) then 
                ...
                state_3283_reg_377 <= ap_const_lv32_1000;
                ...
                state_3283_reg_377 <= ap_const_lv32_0;
            end if; 
        end if;
    end process;
    ...
    j_1_fu_553_p2 <= std_logic_vector(unsigned(j_reg_316) + unsigned(ap_const_lv2_1));
