...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename coefs_2 \
    op interface \
    ports { coefs_2_address0 { O 7 vector } coefs_2_ce0 { O 1 bit } coefs_2_we0 { O 1 bit } coefs_2_d0 { O 32 vector } coefs_2_address1 { O 7 vector } coefs_2_ce1 { O 1 bit } coefs_2_q1 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'coefs_2'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_coef_scale \
    op interface \
    ports { coef_scale { I 32 vector } } \
} "
}
